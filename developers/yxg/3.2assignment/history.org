...
* [2.6.25 - 2.6.29] rt: move update_wall_time back to do timer {C::performance::irq::move update_wall_time() back into do_timer}
  ...
  - 3.0
* [2.6.26         ] m68knommu-make-cmpxchg-RT-safe.patch {C::feature::check::add compile time check of IRQ flags}
  + [[file:2.6.26/m68knommu-make-cmpxchg-RT-safe.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwlock-torture-no-rt.patch {C::bug::compile::compiling_err::syntax::fix torture test to handle non-rt, access undefined struct member }
...
* [2.6.26         ]rt-rwlock-conservative-locking.patch {C::bug::data_err::atomicity::mutex::rwlock: be more conservative in locking reader_lock_count}
  ...
  - 2.6.29
* [2.6.26         ] trace-ktime-scalar.patch{C::maintain::refactor::ftrace: print ktime values in readable form}
...
* [2.6.26         ] ppc64-fix-preempt-unsafe-paths-accessing-per_cpu-variables {C::bug::data_err::preempt::preempt::Fix preempt unsafe paths accessing per_cpu variables}
  ...
  - 2.6.29
* [2.6.26         ] ftrace-fix-get-kprobe-wreckage {C::bug::compile::compiling_err::syntax::add a get_kprobe function }
  + [[file:2.6.26/ftrace-fix-get-kprobe-wreckage.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] multi-reader-lock-account.patch {C::feature::rtsupport::map read/write locks back to their readers}
  + [[file:2.6.26/multi-reader-lock-account.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-dont-trace-markers.patch {C::feature::debuginfo::ftrace: dont trace markers, Do not trace debug files and internal ftrace files}
  + [[file:2.6.26/ftrace-dont-trace-markers.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] arm-omap-02.patch {C::bug::compile::compiling_err::syntax::RT: wrap BUILD_CHECK_IRQ_FLAGS}
...
* [2.6.26         ] rwlock-protect-reader_lock_count.patch {C::bug::data_err::atomicity::mutex::rwlock protect reader_lock_count}
  ...
  - 2.6.29
* [2.6.26         ] ftrace-compile-fixes.patch {C::bug::compile::compiling_err::syntax:: remove call to stop tracer}
  + [[file:2.6.26/ftrace-compile-fixes.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] m68knommu_fixes_ontop_of_v2.6.26.patch {C::maintain::refactor}
...
* [2.6.26         ] sched-cpupri-hotplug-support.patch {C::bug::crash::migration::migration::sched: fix cpupri hotplug support}
  ...
  - 2.6.29
* [2.6.26         ]  rwlocks-multiple-readers.patch   {C::feature::rtsupport::adds the managment for rwlocks to have multiple readers}
  + [[file:2.6.26/rwlocks-multiple-readers.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] radix-tree-lockdep-plus1.patch {C::bug::data_err::semantics::semantics::array was off by 1}
  + [[file:2.6.26/radix-tree-lockdep-plus1.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] pmtmr-override.patch   {C::feature::hardware::pmtmr: allow command line override of ioport}
  + [[file:2.6.26/pmtmr-override.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rtmutex-debug-fix.patch {C::feature::debuginfo::add task_free info}
  + [[file:2.6.26/rtmutex-debug-fix.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ]rwlock-prio-fix.patch {C::bug::deadlock::semantics::mutex::rwlock: reset prio on unlocks and wakeups}
  + [[file:2.6.26/rwlock-prio-fix.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-document-event-tracer.patch{C::maintain::donothing:: add  ftrace-document-event-tracer}
  + [[file:2.6.26/ftrace-document-event-tracer.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ]  nmi-show-regs-fix.patch  {C::bug::hang::hardware::hardware::fix sysrq+l when nmi_watchdog disabled}
  + [[file:2.6.26/nmi-show-regs-fix.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-function-record-nop.patch {C::maintain::refactor::ftrace: define function trace nop}
  + [[file:2.6.26/ftrace-function-record-nop.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] multi-reader-account.patch{C::feature::statistics::keeps track of all reader locks that are held for a task}
  + [[file:2.6.26/multi-reader-account.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwlock-slowunlock-mutex-fix2.patch {C::bug::deadlock::semantics::semantics::rt_read_slowunlock:If readers still own this lock, then we need  to update the pi_list too}
  + [[file:2.6.26/rwlock-slowunlock-mutex-fix2.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-m68knommu-generic-stacktrace-function.patch {C::feature::debuginfo::provides the generic stack trace interface}
  + [[file:2.6.26/ftrace-m68knommu-generic-stacktrace-function.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] powerpc-ftrace-stop-on-oops.patch{C::feature::debuginfo::Stop tracing, when we run into an oops/bug.}
  + [[file:2.6.26/powerpc-ftrace-stop-on-oops.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] preempt-realtime-ftrace-disable-ftraced.patch{C::feature::rtsupport::preempt-realtime-ftrace-disable-ftraced}
  + [[file:2.6.26/preempt-realtime-ftrace-disable-ftraced.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-fix-header.patch {C::bug::compile::compiling_err::syntax::add a header file,fix to handle compiling debugging without CONFIG_FTRACE}
  + [[file:2.6.26/ftrace-fix-header.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-preempt-trace-check.patch {C::bug::data_err::semantics::semantics::ftrace: only trace preempt off with preempt tracer}
  + [[file:2.6.26/ftrace-preempt-trace-check.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-trace-sched.patch {C::feature::debuginfo::trace sched.c}
...
* [2.6.26         ] mapping_nrpages-fix.patch {C::bug::data_err::atomicity::mutex::use  atomic_long_read instead of direct access struct member}
  ...
  - 2.6.29
* [2.6.26         ] arm-fix-compile-error-trace-exit-idle.patch{{C::bug::compile::compiling_err::syntax::delet undefined fuction}
...
* [2.6.26         ] ftrace-wakeup-rawspinlock.patch {C::bug::hang::preempt::preempt::ftrace: user raw spin lock for wakeup function trace}
  ...
  - 2.6.29
* [2.6.26         ] ftrace-stop-trace-on-crash.patch{C::feature::debuginfo::ftrace stop trace on crash}
  + [[file:2.6.26/ftrace-stop-trace-on-crash.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwlock-torture.patch {C::feature::testcase::torture tests for Priority Inheritance RW locks}
  + [[file:2.6.26/rwlock-torture.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] eevent-trace-hrtimer-trace.patch {C::feature::debuginfo::event-tracer: add clockevent trace}
  + [[file:2.6.26/event-trace-hrtimer-trace.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-m68knommu-add-FTRACE-support.patch {C::feature::debuginfo::event-tracer: m68knommu: add FTRACE support}
  + [[file:2.6.26/ftrace-m68knommu-add-FTRACE-support.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-record-comm-on-ctrl.patch {C::feature::debuginfo::ftrace: record comm on function ctrl change}
  + [[file:2.6.26/ftrace-record-comm-on-ctrl.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] lockstat-fix-contention-points.patch {C::bug::data_err::semantics::semantics::lockstat: fix contention points}
...
* [2.6.26         ] trace-do-not-wakeup-when-irqs-disabled.patch {C::bug::deadlock::irq::irq::trace do not wakeup when irqs disabled in the PREEMPT_RT case.}
  ...
  - 2.6.29
* [2.6.26         ] trace_hist-latediv.patch  {C::maintain::refactor::trace_hist late  div }
  + [[file:2.6.26/trace_hist-latediv.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwlock-implement-downgrade-write.patch {C::feature::rtsupport::rwlocks multi downgrade write}
  + [[file:2.6.26/rwlock-implement-downgrade-write.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] multi-reader-pi.patch {C::feature::rtsupport::read lock Priority Inheritance implementation}
  + [[file:2.6.26/multi-reader-pi.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] trace_hist-divzero.patch {C::performance::smallsize:: reduce the divide operate counts }
  + [[file:2.6.26/trace_hist-divzero.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ]warn-on-rt-scatterlist.patch {C::feature::rtsupport::remove warn on for scatterlist in preempt rt}
  + [[file:2.6.26/warn-on-rt-scatterlist.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] frace-use-tsc.patch{C::bug::data_err::time::hardware::Use tsc as ftrace clock till we get all the sched_clock fixes in}
  + [[file:2.6.26/frace-use-tsc.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rt-mutex-namespace.patch  {C::maintain::refactor::rt-mutex-namespace }
  + [[file:2.6.26/rt-mutex-namespace.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rt-mutex-use-inline.patch {C::maintain::refactor::rt-mutex-use-inline }
  + [[file:2.6.26/rt-mutex-use-inline.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] sched-nr-migrate-lower-default-preempt-rt.patch {C::performance::migration::make sched-nr-migrate default value lower }
  + [[file:2.6.26/sched-nr-migrate-lower-default-preempt-rt.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwlocks-default-nr-readers-nr-cpus.patch{C::performance::mutex::Limit the number of readers to number of CPUS by default}
  + [[file:2.6.26/rwlocks-default-nr-readers-nr-cpus.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] multi-reader-limit.patch {C::feature::rtsupport::implement reader limit on read write locks}
  + [[file:2.6.26/multi-reader-limit.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] idle2-fix.patch{C::bug::compile::compiling_err::syntax::nohz: adjust tick_nohz_stop_sched_tick() call of s390 as well}
  + [[file:2.6.26/idle2-fix.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-print-missing-cmdline.patch {C::bug::data_err::semantics::semantics::ftrace: fix the command line printing}
  + [[file:2.6.26/ftrace-print-missing-cmdline.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] lockstat-output.patch {C::feature::debuginfo::warn about disabled lock debugging}
  + [[file:2.6.26/lockstat-output.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-document-update1.patch {C::maintain::donothing:: ftrace: document updates}
  + [[file:2.6.26/ftrace-document-update1.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-hotplug-fix.patch {C::bug::crash::hardware::hardware:::disable the function tracer when bringing up a new CPU.}
  + [[file:2.6.26/ftrace-hotplug-fix.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] sched-cpupri-priocount.patch {C::bug::data_err::semantics::semantics::rounding error off by one}
  + [[file:2.6.26/sched-cpupri-priocount.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] lockdep-avoid-fork-waring.patch {C::bug::crash::semantics::semantics::The preprocessor condition }
...
* [2.6.26         ] idle-fix.patch{C::bug::hwerr::irq::hardware::nohz: prevent tick stop outside of the idle loop}
  ...
  - 2.6.29
* [2.6.26         ] sched-prioritize-non-migrating-rt-tasks.patch{C::feature::rtsupport::sched: prioritize non-migratable tasks over migratable}
...
* [2.6.26         ] fix-a-previously-reverted-fix.patch {C::bug::hang::irq::irq::preempt_schedule_irq}
  ...
  - 2.6.29
* [2.6.26         ] native-sched-clock-booboo.patch {C::bug::compile::compiling_err::syntax::fix return value}
  + [[file:2.6.26/native-sched-clock-booboo.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] trace-eip2ip.patch {C::bug::compile::compiling_err::syntax::change eip to ip}
  + [[file:2.6.26/trace-eip2ip.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwsems-multiple-readers.patch{C::feature::rtsupport::rw_mutex add framework for multi readers on rwsems}
...
* [2.6.26         ]rwlock-fixes.patch{C::bug::deadlock::atomicity::mutex::rwlock: fix pi_list race conditions} 
  ...
  - 2.6.29
* [2.6.26         ] rtmutex-rwlock-cmpxchg-typecast.patch {C::bug::compile::compiling_err::syntax::Compile warning rtmutex code  type cast}
  + [[file:2.6.26/rtmutex-rwlock-cmpxchg-typecast.patch][2.6.26]]
  - 2.6.29
* [2.6.26 - 2.6.29] realtime-preempt-warn-about-tracing.patch {C::maintain::refactor::realtime: preempt warn about tracing}
  ...
  - 3.0
* [2.6.26 - 2.6.29] adaptive-optimize-rt-lock-wakeup.patch{C::performance::mutex::optimize rt lock wakeup}
...
* [2.6.26 - 2.6.29] raw-spinlocks-for-nmi-print.patch {C::bug::data_err::atomicity::mutex::change spinlock to be raw spinlock when serializing prints from NMI}
  ...
  - 3.0
* [2.6.26 - 2.6.29] adaptive-adjust-pi-wakeup.patch {C::performance::mutex::adjust pi_lock usage in wakeup}
  + [[file:2.6.26/adaptive-adjust-pi-wakeup.patch][2.6.26]]
    [[file:2.6.29/adaptive-adjust-pi-wakeup.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29]git-ignore-script-lpp.patch {C::maintain::donothing:: gitignore scripts/testlpp}
  + [[file:2.6.26/git-ignore-script-lpp.patch][2.6.26]]
    [[file:2.6.29/git-ignore-script-lpp.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] sched-wake_up_idle_cpu-rt.patch {C::feature::rtsupport::use raw_smp_processor_id() instead of smp_processor_id() }
  + [[file:2.6.26/sched-wake_up_idle_cpu-rt.patch][2.6.26]]
    [[file:2.6.29/sched-wake_up_idle_cpu-rt.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] rtmutex-rearrange.patch {C::maintain::refactor::rearrange rt_spin_lock_slowlock sleeping code}
  + [[file:2.6.26/rtmutex-rearrange.patch][2.6.26]]
    [[file:2.6.29/rtmutex-rearrange.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] fix-adaptive-hack.patch{C::bug::deadlock::semantics::mutex::fix-adaptive-hack}
...
* [2.6.26 - 2.6.29] arm-omap-05.patch{C::bug::deadlock::deadlock::semantics::  ARM: OMAP: remove unnecessary locking in clk_get_rate()}
  ...
  - 3.0
* [2.6.26 - 2.6.29] adaptive-earlybreak-on-steal.patch {C::performance::smallsize::rtmutex: break out early on first run}
  + [[file:2.6.26/adaptive-earlybreak-on-steal.patch][2.6.26]]
    [[file:2.6.29/adaptive-earlybreak-on-steal.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] adapt-remove-extra-try-to-lock.patch {C::performance::smallsize::remove the extra call to try_to_take_lock}
...
* [2.6.26 - 2.6.29] sched-fix-dequeued-race.patch {C::bug::crash::sched::sched::sched-fix-dequeued-race}
  ...
  - 3.0
* [2.6.26 - 2.6.29] rtmutex-lateral-steal.patch{C::performance::mutex::allow rt-mutex lock-stealing to include lateral priority}
  + [[file:2.6.26/rtmutex-lateral-steal.patch][2.6.26]]
    [[file:2.6.29/rtmutex-lateral-steal.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] rtmutex-remove-xchg.patch {C::performance::smallsize:: rtmutex - remove double xchg}
  + [[file:2.6.26/rtmutex-remove-xchg.patch][2.6.26]]
    [[file:2.6.29/rtmutex-remove-xchg.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] revert-preempt-bkl-revert.patch {C::performance::mutex::BKL: revert back to the old spinlock implementation}
  + [[file:2.6.26/revert-preempt-bkl-revert.patch][2.6.26]]
  m [[file:2.6.29/revert-preempt-bkl-revert.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] adaptive-task-oncpu.patch{C::feature::sched::sched: make task->oncpu available in all configurations}
  + [[file:2.6.26/adaptive-task-oncpu.patch][2.6.26]]
  m [[file:2.6.29/adaptive-task-oncpu.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] bz235099-idle-load-fix.patch {C::bug::data_err::semantics::semantics::fix for load average calculation} 
...
* [2.6.26 - 2.6.29]fix-config-debug-rt-mutex-lock-underflow-warnings.patch {C::bug::data_err::atomicity::mutex::converts lock_count to a atomic_t}
  ...
  - 3.0
* [2.6.26 - 2.6.29]fix_vdso_gtod_vsyscall64_2.patch {C::performance::hrtimer:: enforces the 1ms resolution}
  + [[file:2.6.26/fix_vdso_gtod_vsyscall64_2.patch][2.6.26]]
  m [[file:2.6.29/fix_vdso_gtod_vsyscall64_2.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] adaptive-spinlock-lite-v2.patch {C::performance::hrtimer::adaptive spinlocks lite}
...
* [2.6.26 -    3.8] generic-cmpxchg-use-raw-local-irq-variant.patch {C::bug::hwerr::irq::hardware::generic: Use raw local irq variant for generic cmpxchg}
  ...
  - 3.10
* [2.6.26 -   3.12] sub-dont-disable-irqs.patch {C::performance::smallsize::rt: dont disable irqs in usb}
  ...
  - 3.14
* [2.6.29         ] rt: page_alloc.c cleanup {C::maintain::refactor:: drain_local_pages_work only in CONFIG_PREEMPT_RT}
  + [[file:2.6.29/rt-page_alloc.c-cleanup.patch][2.6.29]]
  - 3.0
* [2.6.29         ] disable-maxcpus-for-now.patch{C::feature::rtsupport::disable maxcpus configure item}
  + [[file:2.6.29/disable-maxcpus-for-now.patch][2.6.29]]
  - 3.0
* [2.6.29         ] preempt-rt-x86-pageattr-flush-unused.patch{C::feature::rtsupport::disable a function call}
  + [[file:2.6.29/preempt-rt-x86-pageattr-flush-unused.patch][2.6.29]]
  - 3.0
* [2.6.29         ] preempt-rt-scatterlist-nort.patch{C::performance::irq::do not need to disable irq}
  + [[file:2.6.29/preempt-rt-scatterlist-nort.patch][2.6.29]]
  - 3.0
* [2.6.29         ] fix-erroneous-histogram-stop-warn-on-messages messages{C::bug::data_err::semantics::semantics::add type check and debuginfo}
  + [[file:2.6.29/fix-erroneous-histogram-stop-warn-on-messages.patch][2.6.29]]
  - 3.0
* [2.6.29         ] mingo: rt spinlock fix{C::feature::rtsupport:: }
  + [[file:2.6.29/rt-mutex-core-fixes2.patch][2.6.29]]
  - 3.0
* [2.6.29         ] seqlock - fix for both PREEMPT_RT and non PREEMPT_RT{C::feature::rtsupport:: }
  + [[file:2.6.29/seqlocks-handle-rwlock-and-spin.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: mingo kernel_sem fix{C::bug::crash::semantics::mutex::rt BKL fix }
  + [[file:2.6.29/rt-mutex-fix-non-lock-kernel-config.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: fix timer.c warning{C::maintain::refactor:: active_rt_tasks only in CONFIG_PREEMPT_RT}
  + [[file:2.6.29/preempt-realtimer-timer-more-non-rt-warning-fixes.patch][2.6.29]]
  - 3.0
* [2.6.29         ] pagealloc-cond-resched-rt-only.patch{C::feature::rtsupport:: replace spin_lock with spin_lock_irqsave, spin_unlock with spin_unlock_irqrestore}
  + [[file:2.6.29/pagealloc-cond-resched-rt-only.patch][2.6.29]]
  - 3.0
* [2.6.29         ] pagealloc: reduce lock sections further{C::performance::mutex::pagealloc: reduce lock sections further}
  + [[file:2.6.29/page-alloc-bulk-moar.patch][2.6.29]]
  - 3.0
* [2.6.29         ] kbuild.patch{C::maintain::refactor:: refactor kbuild}
  + [[file:2.6.29/kbuild.patch][2.6.29]]
  - 3.0
* [2.6.29         ] powerpc-rtmutex.patch{C::feature::rtsupport:: powerpc-rtmutex}
  + [[file:2.6.29/powerpc-rtmutex.patch][2.6.29]]
  - 3.0
* [2.6.29         ] signals: allow rt tasks to cache one sigqueue struct{C::feature::rtsupport::signals: allow rt tasks to cache one sigqueue struct}
  + [[file:2.6.29/signal-keep-a-task-private-siginfo-for-rt-tasks.patch][2.6.29]]
  - 3.0
* [2.6.29         ] preempt: realtime sched remove debug{C::feature::debuginfo::realtime sched remove debug}
  + [[file:2.6.29/preempt-realtime-sched-remove-debug.patch][2.6.29]]
  - 3.0
* [2.6.29         ] genirq-warn-on-do-irq.patch{C::feature::debuginfo::genirq-warn-on-do-irq}
  + [[file:2.6.29/genirq-warn-on-do-irq.patch][2.6.29]]
  - 3.0
* [2.6.29         ] cpu-hotplug: vs slab{C::feature::rtsupport::fix up the slab allocator to be cpu-hotplug safe}
  + [[file:2.6.29/cpuhotplug-vs-slab.patch][2.6.29]]
  - 3.0
* [2.6.29         ] slab-free-pages.patch{C::feature::other}
  + [[file:2.6.29/slab-free-pages.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: convert stop_machine_run() to PREEMPT_RT{C::feature::rtsupport::rt: convert stop_machine_run() to PREEMPT_RT}
  + [[file:2.6.29/rt-stop-cpus-fix.patch][2.6.29]]
  - 3.0
* [2.6.29         ] powerpc-compat-semaphore.patch{C::maintain::refactor:: COMPAT_DECLARE_MUTEX}
  + [[file:2.6.29/powerpc-compat-semaphore.patch][2.6.29]]
  - 3.0
* [2.6.29         ] revert-bkl-cleanup.patch {C::maintain::refactor::test_thread_flag}
  + [[file:2.6.29/revert-bkl-cleanup.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: fix RCU menuconfig{C::feature::rtsupport::rt: fix RCU menuconfig }
  + [[file:2.6.29/preempt-realtime-force-rcu-preempt.patch][2.6.29]]
  - 3.0
* [2.6.29         ] lockdep: fix compat_sema_init{C::bug::na::uninit_var::memory::spin_lock_init}
  + [[file:2.6.29/lockdep-compat-sema-fix.patch][2.6.29]]
  - 3.0
* [2.6.29         ] x86-microcode-fix-sysfs-wreckage.patch{C::bug::crash::hardware::hardware::x86-microcode-fix-sysfs-wreckage}
  + [[file:2.6.29/x86-microcode-fix-sysfs-wreckage.patch][2.6.29]]
  - 3.0
* [2.6.29         ] revert-sched-changes.patch{C::feature::rtsupport:: revert-sched-changes}
...
* [2.6.29         ] remove one extra (incorrect) test in mask_ack_irq(){C::bug::hwerr::irq::irq::remove one extra (incorrect) test in mask_ack_irq()}
  ...
  - 3.0
* [2.6.29         ] hrtimer-fix-wait-for-hrtimer.patch{C::bug::hwerr::time::semantics::hrtimer-fix-wait-for-hrtimer}
...
* [2.6.29         ] cpu-hotplug: cpu_down vs preempt-rt{C::bug::crash::sched::idle:: using mmdrop_delayed_drop fun}
  ...
  - 3.0
* [2.6.29         ] rtmutex: remove uber optimization{C::feature::rtsupport::remove some codes}
  + [[file:2.6.29/tglx-05-rtmutex-remove-uber-optimization.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: xfs fix{C::feature::rtsupport::XFS still relies on compat semaphore}
  + [[file:2.6.29/preempt-realtime-xfs-compat-semaphore.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: mutex core fixes{C::feature::rtsupport::replace rwsem_is_locked with compat_rwsem_is_locked}
  + [[file:2.6.29/rt-mutex-core-fixes.patch][2.6.29]]
  - 3.0
* [2.6.29         ] preempt-realtime-tracer.patch{C::feature::rtsupport::preempt-realtime-tracer}
  + [[file:2.6.29/preempt-realtime-tracer.patch][2.6.29]]
  - 3.0
* [2.6.29         ] trace-setprio.patch{C::feature::debuginfo::trace-setprio}
  + [[file:2.6.29/trace-setprio.patch][2.6.29]]
  - 3.0
* [2.6.29         ] net: xmit lock owner cleanup{C::maintain::refactor::net: xmit lock owner cleanup}
  + [[file:2.6.29/net-xmit-lock-owner-cleanup.patch][2.6.29]]
  - 3.0
* [2.6.29         ] net: clean up dev_queue_xmit() code flow{C::maintain::refactor::net: clean up dev_queue_xmit() code}
...
* [2.6.29         ] percpu-locked-netfilter-ecache.patch{C::bug::data_err::atomicity::mutex::add spinlock}
  ...
  - 3.0
* [2.6.29         ] add -rt version tag{C::maintain::donothing:: update version number}
  + [[file:2.6.29/version.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: port hardirq threading to CONFIG_SPARSEIRQ{C::feature::rtsupport::rt: port hardirq threading to CONFIG_SPARSEIRQ}
  + [[file:2.6.29/preempt-realtime-irqthreading-sparseirq-fixups.patch][2.6.29]]
  - 3.0
* [2.6.29         ] seqlock: make sure that raw_seqlock_t retries readers while writes are pending] {C::bug::livelock::semantics::semantics::seqlock: make sure that raw_seqlock_t retries readers while writes are pending}
  + [[file:2.6.29/seqlock-01-make-sure-that-raw_seqlock-retries.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt-spin-needbreak-fixup.patch{C::bug::livelock::semantics::semantics::rt-spin-needbreak-fixup}
  + [[file:2.6.29/rt-spin-needbreak-fixup.patch][2.6.29]]
  - 3.0
* [2.6.29         ] powerpc-rawlocks.patch{C::feature::rtsupport::powerpc-rawlocks}
  + [[file:2.6.29/powerpc-rawlocks.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rtmutex: unify state manipulation{}{C::bug::data_err::semantics::semantics::rtmutex: unify state manipulation}
  + [[file:2.6.29/tglx-04-rtmutex-unify-state-manipulation.patch][2.6.29]]
  - 3.0
* [2.6.29         ] preempt: irqs port fixes{C::feature::rtsupport::cpumask infrastructure related changes}
  + [[file:2.6.29/preempt-irqs-port-fixes.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: CONFIG_SPARSEIRQ=y fix{C::data_err::uninit_var::memory::The desc->wait_for_handler waitqueue needs to be initialized for
...
* [2.6.29         ] -rt, bit-spinlocks: add __bit_spin_unlock(){C::bug::data_err::atomicity::mutex::add __bit_spin_unlock}
  ...
  - 3.0
* [2.6.29         ] netfilter-rcu-destroy.patch{C::feature::rtsupport::use a rcu callback for nf_conntrack_destroy}
  + [[file:2.6.29/netfilter-rcu-destroy.patch][2.6.29]]
  - 3.0
* [2.6.29         ] add -rt extra-version{C::feature::rtsupport:: rtmutex support}
  + [[file:2.6.29/rt-mutex-core-mutex-fixes.patch][2.6.29]]
  - 3.0
* [2.6.29         ] preempt-realtime-x86-32-gup-kmapatomic.patch{C::feature::mm::kmap/kunmpa_atomic_...}
...
* [2.6.29         ] x86: fix sparse irq vector{C::bug::hwerr::irq::irq:: fix sparse irq vector}
  ...
  - 3.0
* [2.6.29         ] arm-tracing-updates.patch{C::feature::debuginfo::add arm ftrace function}
  + [[file:2.6.29/arm-tracing-updates.patch][2.6.29]]
  - 3.0
* [2.6.29         ] arm-fix-compile-1.patch{C::bug::compile::compiling_err::syntax::add head file}
  + [[file:2.6.29/arm-fix-compile-1.patch][2.6.29]]
  - 3.0
* [2.6.29         ] powerpc-pseries-rtasd-irq-disable-check-non-rt.patch{C::feature::check::disable check non rt}
  + [[file:2.6.29/powerpc-pseries-rtasd-irq-disable-check-non-rt.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: sparseirq build fix{C::bug::compile::compiling_err::semantics:: replace __SPIN_LOCK_UNLOCKED with RAW_SPIN_LOCK_UNLOCKED}
  + [[file:2.6.29/preempt-realtime-fix-irqdesc-lock-initializers.patch][2.6.29]]
  - 3.0
* [2.6.29         ] per: cpu locked infrastructure{C::feature::rtsupport::per: cpu locked infrastructure}
  + [[file:2.6.29/per-cpu-locked-infrastructure.patch][2.6.29]]
  - 3.0
* [2.6.29         ] threaded-irq-revert-for-first-shot.patch{C::feature::rtsupport::threaded-irq-revert-for-first-shot}
  + [[file:2.6.29/threaded-irq-revert-for-first-shot.patch][2.6.29]]
  - 3.0
* [2.6.29         ] cpu-hotplug: get_cpu_var_locked online aware{C::feature::hardware::cpu-hotplug: get_cpu_var_locked online aware}
...
* [2.6.29         ] preempt-realtime-debugobjects-rt-safe.patch{C::bug::data_err::atomicity::mutex::replace spinlock_t with raw_spinlock_t}
  ...
  - 3.0
* [2.6.29         ] mm-lock-break-on-bulk.patch{C::feature::rtsupport::add CALLING cond_resched_lock fun}
...
* [2.6.29         ] suppress warning of smp_processor_id use.{C::bug::crash::preempt::preempt::use preempt_disable() to supress waring message}
  ...
  - 3.0
* [2.6.29         ] irq: desc init{C::feature::rtsupport::replace __SPIN_LOCK_UNLOCKED with RAW_SPIN_LOCK_UNLOCKED}
  + [[file:2.6.29/irq-desc-init.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rtmutex: prevent missed wakeups{C::bug::hang::semantics::semantics::rtmutex: prevent missed wakeups}
  + [[file:2.6.29/tglx-07-rtmutex-prevent-missed-wakeups.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: btrfs locking fix/workaround{C::feature::rtsupport:: make this function return 0 if in PREEMPT_RT }
...
* [2.6.29         ] patches/fix-net-bug-fixes.patch{C::bug::hwerr::atomicity::mutex:: declare it as a PER_CPU_LOCKED, but then never use the extra lock to synchronize data}
  ...
  - 3.0
* [2.6.29         ] rt: fix paravirt spinlocks{C::feature::rtsupport:: use __raw_spinlock_t instead of raw_spinlock_t}
  + [[file:2.6.29/preempt-realtime-paravirt-spinlocks-fix.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rtmutex-mutex-fixups.patch{C::bug::compile::compiling_err::semantics:: chang conditional compile}
  + [[file:2.6.29/rtmutex-mutex-fixups.patch][2.6.29]]
  - 3.0
* [2.6.29         ] cpu-hotplug: preemptible page_alloc{C::feature::rtsupport:: preemptible page_alloc}
  + [[file:2.6.29/cpuhotplug-page_alloc.patch][2.6.29]]
  - 3.0
* [2.6.29         ] powerpc-raw-spin-unlock-wait-disable-preemption.patch{C::feature::rtsupport::powerpc-raw-spin-unlock-wait-disable-preemption}
  + [[file:2.6.29/powerpc-raw-spin-unlock-wait-disable-preemption.patch][2.6.29]]
  - 3.0
* [2.6.29         ] t: fix ipi call lock{C::feature::rtsupport::call_function_lock needs to be raw too - it gets called from atomic}
IPI context.
  + [[file:2.6.29/preempt-realtime-ipi-call-lock-raw.patch][2.6.29]]
  - 3.0
* [2.6.29         ] trace-disable-hw-branch-tracer.patch{C::feature::debuginfo::disable-hw-branch-tracer in PREEMPT_RT}
  + [[file:2.6.29/trace-disable-hw-branch-tracer.patch][2.6.29]]
  - 3.0
* [2.6.29         ] resurrect: softirq code{C::feature::rtsupport:: use softirq}
  + [[file:2.6.29/resurrect-softirq-code.patch][2.6.29]]
  - 3.0
* [2.6.29         ] powerpc-percpu-tlb.patch{C::feature::rtsupport::powerpc-percpu-tlb}
  + [[file:2.6.29/powerpc-percpu-tlb.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: no workqueue tracer{C::bug::deadlock::semantics::semantics:: disable-workqueue-tracer-on-preempt-rt to avoid call sleeping function }
...
* [2.6.29         ] rt: signals struct lock init fix{C::bug::data_err::atomicity::mutex::ignals struct lock init fix}
  ...
  - 3.0
* [2.6.29         ] powerpc-realtime-preempt.patch{C::feature::rtsupport::powerpc-realtime-preempt}
  + [[file:2.6.29/powerpc-realtime-preempt.patch][2.6.29]]
  - 3.0
* [2.6.29         ] lockdep: atomic fixup{C::bug::compile::compiling_err::syntax:: use atomic_t instead of int}
  + [[file:2.6.29/lockdep-atomic-fixup.patch][2.6.29]]
  - 3.0
* [2.6.29         ] highmem: atomic fix{C::bug::compile::semantics::semantics:: disalble BUG_ON check}
...
* [2.6.29 -    3.4] timers: fix timer hotplug on -rt{C::bug::hwerr::irq::irq::in the CPU_DEAD notifier, must not sleep nor enable interrupts.}
  ...
  - 3.6
* [2.6.29 -    3.6] signals: Do not wakeup self{C::bug::hang::semantics::semantics::signal_wake_up  signals: Do not wakeup self}
  ...
  - 3.8
* [2.6.29 -    3.8] timers: mov printk_tick to soft interrupt{C::performance::irq:: mov printk_tick to soft interrupt}
  ...
  - 3.10
* [2.6.29 -    4.0] posix-timers: Shorten posix_cpu_timers/<CPU> kernel thread names{C::bug::data_err::overflow::semantics::Shorten the softirq kernel thread names because they always overflow the limited comm length, appearing as "posix_cpu_timer" CPU# times.}
  ...
  - 4.1
* [2.6.29 -    4.0] posix-timers: Avoid wakeups when no timers are active{C::performance::smallsize::posix-timers: Avoid wakeups when no timers are active,Waking the thread even when no timers are scheduled is useless.}
...
* [   3.0         ] x86-iommu-rt-aware.patch{C::feature::rtsupport::replace with raw}
  ...
  - 3.2
* [   3.0         ] ftrace-hash-fix.patch{C::bug::data_err::semantics::semantics::add and replace old fun}
...
* [   3.0         ] sched: remove useles get_cpu() in sched_fork(){C::feature::rtsupport::said to rm useless preempt disable}
  ...
  - 3.2
* [   3.0         ] rtc: Handle errors correctly in rtc_irq_set_state(){}{C::bug::ctrl_err::semantics::semantics::release spinlock when meet err}
...
* [   3.0         ] fs: Convert i_alloc_sem to rw_anon_semaphore{C::feature::rtsupport::replace with raw}
  ...
  - 3.2
* [   3.0         ] watchdog-madness.patch{C::bug::hwerr::typo_var::memory::rm static, add set scheduler fun}
  + [[file:3.0/watchdog-madness.patch][3.0]]
  - 3.2
* [   3.0         ] mips: sibyte: Add missing irq_mask function{C::bug::compile::compiling_err::syntax::rename a field}
  + [[file:3.0/mips-sibyte-fix-irq-chip.patch][3.0]]
  - 3.2
* [   3.0         ] sched-show-state-no-task-list-lock.patch{C::feature::rtsupport::replace rd_lock with rcu_read_lock}
...
* [   3.0 -    3.4] genirq: Disable random call on preempt-rt{C::feature::rtsupport::disable random call on preempt rt}
  ...
  - 3.6
* [   3.0 -    3.4] arm-enable-interrupts-in-signal-code.patch{}{C::feature::rtsupport::add irq in signal code}
...
* [   3.0 -    3.8] locking-various-init-fixes.patch{C::bug::data_err::typo_var::semantics::replace with ref}
  ...
  - 3.10
* [   3.0 -    3.8] stomp-machine-mark-stomper-thread.patch{C::feature::other::add flag, and init p with it}
...
* [   3.0 -   3.10] mm-slab-wrap-functions.patch{C::feature::rtsupport::wrap fun, replace spin with local_spinlk to disable preemption}
  ...
  - 3.12
* [   3.0 -   3.12] list-add-list-last-entry.patch{C::feature::other::add macro to get list end}
  ...
  - 3.14
* [   3.0 -   3.12] mm: shrink the page frame to !-rt size{C::feature::rtsupport::mm__rt spinlock dynamic allocator when all pte_page}
  ...
  - 3.14
* [   3.0 -   3.14] x86: Disable IST stacks for debug/int 3/stack fault for PREEMPT_RT{C::feature::rtsupport::disable ist stacks ... in rt}
...
* [   3.0 -   3.14] mm: Replace cgroup_page bit spinlock{C::feature::mm::add spinlock to control pcg&pcm lock}
  ...
  - 3.18
* [   3.0 -   3.14] filemap-fix-up.patch{C::bug::crash::semantics::semantics::replace in_atomic in bug on with pagefault_disabled} 
...
* [   3.0 -    4.0] mm-page-alloc-use-list-last-entry.patch{C::maintain::refactor::replace with a new fun}
  ...
  - 4.1
* [   3.0 -    4.0] local-vars-migrate-disable.patch{C::feature::rtsupport::implement non-rt _cpu_var funs}
...
* [   3.0 -    4.0] x86-no-perf-irq-work-rt.patch{C::feature::capability::add rt config and var to record}
  ...
  - 4.1
* [   3.0 -    4.0] mips-enable-interrupts-in-signal.patch{C::feature::rtsupport::enable irq in signal}
...
* [   3.0 -    4.0] rt-mutex-add-sleeping-spinlocks-support.patch{C::feature::rtsupport::implement rt spinlock, rt fast/slow lock}
  ...
  - 4.1
* [   3.0 -    4.0] sched-migrate-disable.patch{C::feature::rtsupport::implement migrate disable}
...
* [   3.0 -    4.6] drivers/net: fix livelock issues{C::bug::livelock::livelock::semantics::rm NETDEV_TX_LOCKED macro optimization}
  ...
  - 4.8
* [   3.0 -    4.8] hwlatdetect.patch{C::feature::check::hwlat detector}
...
* [   3.0 -   4.11] printk: Add a printk kill switch{C::feature::check::printk kill switch}
...
* [   3.0 -   4.11] net: sysrq via icmp{C::feature::debuginfo::enable sysrq to rcmp}
...
* [   3.0 -   4.11] x86: Convert mce timer to hrtimer{C::bug::deadlock::time::semantics::convert mce to hrtimer}
...
* [   3.0 -   4.11] posix-timers: Thread posix-cpu-timers on -rt{C::feature::rtsupport::impl thread posix cpu timers}
...
* [   3.0 -   4.11] ARM: AT91: PIT: Remove irq handler when clock event is unused{C::feature::timer::setup rm irq handler in clk evnt mode selection}
...
* [   3.0 -   4.11] timer: delay waking softirqs from the jiffy tick{C::performance::migration::reorder fun}
...
* [   3.0 -   4.11] tracing: Add latency histograms{C::feature::statistics::add latency histograms}
...
* [   3.0 -   4.11] clocksource: TCLIB: Allow higher clock rates for clock events{C::feature::timer::add check to allow higher clk rate}
...
* [   3.0 -   4.11] hotplug: Lightweight get online cpus{C::feature::hotplug::add fun to get online cpu}
...
* [   3.0 -   4.11] trace: Add migrate-disabled counter to tracing output{C::feature::debuginfo::add migrate_disable trace in rt}
...
* [   3.2         ] wait: Provide __wake_up_all_locked{C::maintain::refactor::add a var to extend fun to wake up all}
  ...
  - 3.4
* [   3.2         ] wait-simple: Simple waitqueue implementation{C::feature::rtsupport::implement a slim version of waitqueue}
...
* [   3.2         ] printk: Disable migration instead of preemption{C::bug::crash::preempt::preempt::replace preempt_disable with migrate_disable}
  ...
  - 3.4
* [   3.2         ] acpi-gpe-use-wait-simple.patch{C::feature::rtsupport::use simple waitqueue}
  + [[file:3.2/acpi-gpe-use-wait-simple.patch][3.2]]
  - 3.4
* [   3.2         ] powerpc: wsp: Mark opb cascade handler IRQF_NO_THREAD{C::feature::rtsupport::mark irq with hard irq}
...
* [   3.2 -    3.4] workqueue: Fix cpuhotplug trainwreck{C::feature::sched::new wq to not respect cpu affinity}
  ...
  - 3.6
* [   3.2 -    3.4] slab: Fix __do_drain to use the right array cache{C::bug::crash::err_var::semantics::replace with rt safe fun}
...
* [   3.2 -    3.4] workqueue: Use get_cpu_light() in flush_gcwq(){C::feature::rtsupport::replace with _light}
  ...
  - 3.6
* [   3.2 -    3.6] ftrace-crap.patch{C::bug::crash::semantics::semantics::implement a rt version fun}
...
* [   3.2 -    3.6] hrtimer: Don't call the timer handler from hrtimer_start{C::bug::hang::hardware::hardware::rm handler from start, return error val instead}
  ...
  - 3.8
* [   3.2 -    3.6] hrtimer: Add missing debug_activate() aid{C::bug::crash::semantics::semantics::simply deactivate the warning trace function}
...
* [   3.2 -    4.0] sched: Optimize migrate_disable{C::feature::rtsupport::replace with raw lock}
  ...
  - 4.1
* [   3.2 -    4.0] tracing: Show padding as unsigned short{C::feature::debuginfo::change var type}
...
* [   3.2 -    4.0] ipc/mqueue: Add a critical section to avoid a deadlock{C::bug::deadlock::deadlock::preempt::diasble preempt}
  ...
  - 4.1
* [   3.2 -    4.0] sched: Postpone actual migration disalbe to schedule{C::feature::rtsupport::new impl of migrate disable}
...
* [   3.2 -    4.6] net: Avoid livelock in net_tx_action() on RT{C::feature::rtsupport::use spinlock to avoid livelock}
  ...
  - 4.8
* [   3.2 -   4.11] hotplug: Reread hotplug_pcp on pin_current_cpu() retry{C::feature::hotplug::update cpu mask}
...
* [   3.2 -   4.11] sysfs: Add /sys/kernel/realtime entry{C::feature::rtsupport::add rt entry}
...
* [   3.2 -   4.11] tracing: Account for preempt off in preempt_schedule(){C::feature::debuginfo::add trace manually}
...
* [   3.2 -   4.11] kgdb/serial: Short term workaround{C::bug::data_err::semantics::semantics::add fun, and move the cnt}
...
* [   3.4         ] lglock/rt: Use non-rt for_each_cpu() in -rt code{C::feature::rtsupport::lglock callback implementation}
  + [[file:3.4/rfc-lglock-rt-use-non-rt-for_each_cpu-in-rt-code.patch][3.4]]
  - 3.6
* [   3.4         ] ring-buffer/rt: Check for irqs disabled before grabbing reader lock{C::feature::rtsupport::add irq check}
  + [[file:3.4/rfc-ring-buffer-rt-check-for-irqs-disabled-before-grabbing-reader-lock.patch][3.4]]
  - 3.6
* [   3.4         ] timer: Fix hotplug for -rt{C::feature::rtsupport::disable sleep in CPU_DEAD}
  + [[file:3.4/rfc-timer-fix-hotplug-for-rt.patch][3.4]]
  - 3.6
* [   3.4         ] futex/rt: Fix possible lockup when taking pi_lock in proxy handler{C::feature::rtsupport::replace with irq disabled}
  + [[file:3.4/rfc-futex-rt-fix-possible-lockup-when-taking-pi_lock-in-proxy-handler.patch][3.4]]
  - 3.6
* [   3.4 -    3.6] rcu: Fix build break{C::bug::compile::compiling_err::syntax::restrict precompile section}
  + [[file:3.4/rcu-fix-build-break.patch][3.4]]
  m [[file:3.6/rcu-fix-build-break.patch][3.6]]
  - 3.8
* [   3.4 -    3.6] timekeeping: Split xtime_lock{C::maintain::refactor::split fun}
  + [[file:3.4/timekeeping-split-xtime-lock.patch][3.4]]
  M [[file:3.6/timekeeping-split-xtime-lock.patch][3.6]]
  - 3.8
* [   3.4 -    3.8] arm-omap-make-wakeupgen_lock-raw.patch{C::feature::rtsupport::replace with raw}
  ...
  - 3.10
* [   3.4 -    3.8] ntp: Make ntp_lock raw.{C::feature::rtsupport::replace with raw}
...
* [   3.4 -   3.12] sched/rt: Fix wait_task_interactive() to test rt_spin_lock state{C::bug::data_err::preempt::preempt::add state check}
  ...
  - 3.14
* [   3.4 -    4.1] x86: Do not disable preemption in int3 on 32bit{C::feature::rtsupport::do dot disable preempt}
...
* [   3.4 -   4.11] rt: Introduce cpu_chill(){C::feature::rtsupport::implement cpu chill}
...
* [   3.4 -   4.11] cpu: Make hotplug.lock a "sleeping" spinlock on RT{C::feature::rtsupport::implement hotplug with spinlock in rt}
...
* [   3.4 -   4.11] signal/x86: Delay calling signals in atomic{C::feature::rtsupport::add fun}
...
* [   3.6         ] Disable RT_GROUP_SCHED in PREEMPT_RT_FULL{C::feature::rtsupport::disable ...}
...
* [   3.6         ] mm: Protect activate_mm() by preempt_[disable%7Cenable]_rt(){C::bug::crash::irq::irq::replace with preempt pair}
  ...
  - 3.8
* [   3.6         ] timer.c: fix build fail for ! RT_FULL{C::bug::compile::compiling_err::syntax::add precompile}
...
* [   3.6         ] mm: slab: Fix potential deadlock{C::bug::deadlock::deadlock::semantics::add macros and replace with it}
  ...
  - 3.8
* [   3.6         ] crypto: Make core builtin and init srcu early{C::bug::crash::uninit_var::memory::enforce init at kern}
  + [[file:3.6/crypto-make-core-static-and-init-scru-early.patch][3.6]]
  - 3.8
* [   3.6 -    3.8] x86: perf: Deal with kfree from atomic contexts{C::feature::rtsupport::replace with lockless for not in a atomic text}
  + [[file:3.6/x86-perf-uncore-deal-with-kfree.patch][3.6]]
    [[file:3.8/x86-perf-uncore-deal-with-kfree.patch][3.8]]
  - 3.10
* [   3.6 -    3.8] genirq: Add default affinity mask command line option{C::feature::rtsupport::allow restriction to the default irq affinity mask}
  + [[file:3.6/genirq-add-default-mask-cmdline-option.patch][3.6]]
    [[file:3.8/genirq-add-default-mask-cmdline-option.patch][3.8]]
  - 3.10
* [   3.6 -    3.8] lockdep: Selftest: convert spinlock to raw spinlock{C::feature::rtsupport::replace with raw}
  ...
  - 3.10
* [   3.6 -    3.8] powerpc: Mark low level irq handlers NO_THREAD{C::feature::rtsupport::make fun NO_THREAD}
...
* [   3.6 -   3.10] rcu: rcutiny: Prevent RCU stall{C::bug::data_err::irq::semantics::modify check}
  ...
  - 3.12
* [   3.6 -   3.14] stomp_machine: Use mutex_trylock when called from inactive cpu{C::feature::rtsupport::add trylock loop to avoid contention}
  ...
  - 3.18
* [   3.6 -   3.14] sched: Add better debug output for might_sleep(){C::feature::debuginfo::add output in might_sleep}
  ...
  - 3.18
* [   3.6 -   3.18] net: Use get_cpu_light() in ip_send_unicast_reply(){C::feature::rtsupport::enclose with get/put_cpu_light pair}
  ...
  - 4.0
* [   3.6 -    4.0] softirq: Init softirq local lock after per cpu section is set up{C::bug::crash::semantics::semantics::change init sequence}
  ...
  - 4.1
* [   3.6 -    4.0] softirq: Split handling function{C::maintain::refactor::split fun out}
  ...
  - 4.1
* [   3.6 -    4.0] softirq: Make serving softirqs a task flag{C::feature::rtsupport::add a flag, rm fun}
  ...
  - 4.1
* [   3.6 -    4.0] rt: rwsem/rwlock: lockdep annotations{C::feature::rtsupport::allow multi-readers}
  ...
  - 4.1
* [   3.6 -    4.1] fs, jbd: pull your plug when waiting for space{C::performance::preempt::sched when plug}
  ...
  - 4.4
* [   3.6 -   4.11] printk: Make rt aware{C::feature::rtsupport::make rt aware}
...
* [   3.6 -   4.11] lockdep: selftest: Only do hardirq context test for raw spinlock{C::feature::rtsupport::selftest only hardirq test}
...
* [   3.6 -   4.11] random: Make it work on rt{C::feature::rtsupport::random IP}
...
* [   3.6 -   4.11] mm: page_alloc: Use local_lock_on() instead of plain spinlock{C::feature::mm::add fun to ease debugging}
...
* [   3.6 -   4.11] softirq: Split softirq locks{C::feature::rtsupport::enclose with lock}
...
* [   3.8         ] timekeeping: Implement a shadow timekeeper{C::feature::timer::timekeeping: Implement a shadow timekeeper}
  + [[file:3.8/timekeeping-implement-shadow-timekeeper.patch][3.8]]
  - 3.10
* [   3.8         ] timekeeping: Store cycle_last value in timekeeper struct as well{C::feature::timer::timekeeping: Store cycle_last value in timekeeper struct as well}
...
* [   3.8         ] printk: Fix rq->lock vs logbuf_lock unlock lock inversion{C::bug::deadlock::deadlock::semantics:: printk: Fix rq->lock vs logbuf_lock unlock lock inversion}
  ...
  - 3.10
* [   3.8         ] timekeeping: Split timekeeper_lock into lock and seqcount{C::performance::mutex::timekeeping: Split timekeeper_lock into lock and seqcount}
  + [[file:3.8/timekeeping-split-timekeeper-lock.patch][3.8]]
  - 3.10
* [   3.8         ] timekeeping: Calc stuff once{C::maintain::refactor::timekeeping: Calc stuff once}
...
* [   3.8         ] powerpc/fsl-msi: use a different locklcass for the cascade interrupt{C::bug::deadlock::deadlock::semantics::powerpc/fsl-msi: use a different locklcass for the cascade interrupt}
  ...
  - 3.10
* [   3.8         ] OF: Convert devtree lock from rw_lock to raw spinlock{C::feature::rtsupport::OF: Convert devtree lock from rw_lock to raw}
  + [[file:3.8/of-convert-devtree-lock-from-rw_lock-to-raw-spinlock.patch][3.8]]
  - 3.10
* [   3.8         ] timekeeping: Delay update of clock->cycle_last{C::performance::smallsize::timekeeping: Delay update of clock->cycle_last}
  + [[file:3.8/timekeeping-delay-clock-cycle-last-update.patch][3.8]]
  - 3.10
* [   3.8         ] timekeeping: Move lock out of timekeeper struct{C::feature::rtsupport::timekeeping: Move lock out of timekeeper }
  + [[file:3.8/timekeeping-move-lock-out-of-timekeeper.patch][3.8]]
  - 3.10
* [   3.8         ] kernel/srcu: merge common code into a macro{C::maintain::refactor::kernel/srcu: merge common code into a macro}
...
* [   3.8         ] FIX [2/2] slub: Tid must be retrieved from the percpu area of the current proces{C::bug::data_err::preempt::preempt::slub: Tid must be retrieved from the percpu area of the current proces}
  ...
  - 3.10
* [   3.8         ] spi/omap-mcspi: check condition also after timeout{C::bug::hwerr::semantics::semantics::spi/omap-mcspi: check condition also after timeout}
  + [[file:3.8/spi-omap-mcspi-check-condition-also-after-timeout.patch][3.8]]
  - 3.10
* [   3.8         ] FIX [1/2] slub: Do not dereference NULL pointer in node_match{C::bug::data_err::err_var::memory::slub: Do not dereference NULL pointer in node_match}
  + [[file:3.8/fix-1-2-slub-do-not-dereference-null-pointer-in-node_match.patch][3.8]]
  - 3.10
* [   3.8         ] timekeeping: Make jiffies_lock internal{C::maintain::refactor::timekeeping: Make jiffies_lock internal}
  + [[file:3.8/timekeeping-make-jiffies-lock-internal.patch][3.8]]
  - 3.10
* [   3.8         ] timekeeping: Shorten seq_count region{C::performance::mutex::timekeeping: Shorten seq_count region}
  + [[file:3.8/timekeeping-shorten-seq-count-region.patch][3.8]]
  - 3.10
* [   3.8 -   3.10] rcutiny: Use simple waitqueue{C::performance::mutex::rcutiny: Use simple waitqueue}
  + [[file:3.8/rcutiny-use-simple-waitqueue.patch][3.8]]
    [[file:3.10/rcutiny-use-simple-waitqueue.patch][3.10]]
  - 3.12
* [   3.8 -   3.12] sched: Adjust sched_reset_on_fork when nothing else changes{C::bug::data_err::sched::sched::sched: Adjust sched_reset_on_fork when nothing else changes}
...
* [   3.8 -   3.14] sched: Queue RT tasks to head when prio drops{C::bug::rtlatency::sched::sched::sched: Queue RT tasks to head when prio drops}
  ...
  - 3.18
* [   3.8 -    4.0] wait-simple: Rework for use with completions{C::feature::rtsupport::wait-simple: Rework for use with completions}
  ...
  - 4.1
* [   3.8 -    4.0] kernel/treercu: use a simple waitqueue{C::performance::mutex::treercu: use a simple waitqueue}
  ...
  - 4.1
* [   3.8 -    4.0] softirq: Adapt NOHZ softirq pending check to new RT scheme{C::feature::rtsupport::softirq: Adapt NOHZ softirq pending check to new RT scheme}
  ...
  - 4.1
* [   3.8 -    4.0] net: Use local_bh_disable in netif_rx_ni(){C::bug::hwerr::semantics::semantics::net: Use local_bh_disable in netif_rx_ni}
  ...
  - 4.1
* [   3.8 -    4.1] hrtimer: Raise softirq if hrtimer irq stalled{C::feature::hrtimer:: hrtimer: Raise softirq if hrtimer irq stalled}
  ...
  - 4.4
* [   3.8 -    4.4] wait-simple: Simple waitqueue implementation{C::feature::rtsupport:: wait-simple: Simple waitqueue implementation}
  ...
  - 4.6
* [   3.8 -    4.6] i2c/omap: drop the lock hard irq context{C::performance::mutex::i2c/omap: drop the lock hard irq }
  ...
  - 4.8
* [   3.8 -   4.11] arm: Enable highmem for rt{C::feature::mm::arm-enable-highmem-for-rt}
...
* [   3.8 -   4.11] printk: Drop the logbuf_lock more often{C::performance::mutex::printk: Drop the logbuf_lock more}
...
* [   3.8 -   4.11] powerpc: Add support for lazy preemption{C::feature::rtsupport::powerpc: Add support for lazy }
...
* [   3.8 -   4.11] net: Add a mutex around devnet_rename_seq{C::performance::preempt:: net: make devnet_rename_seq a mutex}
...
* [   3.8 -   4.11] sched: Add support for lazy preemption{C::feature::sched::sched: Add support for lazy preemptions}
...
* [   3.8 -   4.11] arm/highmem: Flush tlb on unmap{C::bug::data_err::hardware::hardware:: arm/highmem: Flush tlb on unmap}
...
* [   3.8 -   4.11] completion: Use simple wait queues{C::performance::mutex::completion: Use simple wait queues}
...
* [   3.8 -   4.11] x86: Support for lazy preemption{C::feature::rtsupport::x86: Support for lazy preemption}
...
* [   3.8 -   4.11] mm: Enable SLUB for RT{C::feature::mm::mm: Enable SLUB for RT}
...
* [   3.8 -   4.11] kernel/SRCU: provide a static initializer{C::feature::rtsupport::SRCU: provide a static initializer}
...
* [   3.8 -   4.11] mmci: Remove bogus local_irq_save(){C::performance::irq::mmci: Remove bogus local_irq_save()}
...
* [   3.8 -   4.11] mm: bounce: Use local_irq_save_nort{C::performance::irq:: mm: bounce: Use local_irq_save_nort}
...
* [   3.8 -   4.11] futex: Ensure lock/unlock symetry versus pi_lock and hash bucket lock{C::bug::deadlock::semantics::semantics::futex: Ensure lock/unlock symetry versus pi_lock and hash bucket lock}
...
* [   3.8 -   4.11] workqueue: Use local irq lock instead of irq disable regions{C::performance::mutex::Use local irq lock instead of irq disable regions}
...
* [   3.8 -   4.11] arm: Add support for lazy preemption{C::feature::rtsupport::arm-preempt-lazy-support}
...
* [   3.8 -   4.11] timekeeping: Split jiffies seqlock{C::performance::mutex::timekeeping: Split jiffies seqlock}
...
* [   3.8 -   4.11] x86/highmem: Add a "already used pte" check{C::feature::check::Add a "already used pte" check}
...
* [  3.10         ] net/cpsw: Use fallback for active_slave{C::feature::net::net/cpsw: Use fallback for active_slave}
  + [[file:3.10/cpsw-net-cpsw-Use-fallback-for-active_slave.patch][3.10]]
  - 3.12
* [  3.10         ] gpu: i915: allow the user not to do the wbinvd{C::bug::hwerr::hardware::hardware::gpu: i915: allow the user not to do the wbinvd}
  + [[file:3.10/gpu-i915-allow-the-user-not-to-do-the-wbinvd.patch][3.10]]
  - 3.12
* [  3.10         ] net/cpsw: revert f9a8f83b04e0c362a2fc660dbad980d24af209fc{C::bug::compile::compiling_err::syntax:: fix function call parameter}
  + [[file:3.10/revert-f9a8f83b04e0c362a2fc660dbad980d24af209fc.patch][3.10]]
  - 3.12
* [  3.10         ] mm-disable-slab-on-rt.patch{C::feature::rtsupport::mm-disable-slab-on-rt}
  + [[file:3.10/mm-disable-slab-on-rt.patch][3.10]]
  - 3.12
* [  3.10         ] net-dev-make-devnet-rename-seq-static.patch{C::bug::hwerr::semantics::semantics:: net-dev-make-devnet-rename-seq-static}
  + [[file:3.10/net-dev-make-devnet-rename-seq-static.patch][3.10]]
  - 3.12
* [  3.10         ] net/cpsw: revert 80d5c3689b886308247da295a228a54df49a44f6{C::bug::hwerr::semantics::semantics::fix function call }
  + [[file:3.10/revert-80d5c3689b886308247da295a228a54df49a44f6.patch][3.10]]
  - 3.12
* [  3.10         ] net/cpsw: revert f646968f8f7c624587de729115d802372b9063dd{C::bug::hwerr::semantics::semantics::change MARCO}
  + [[file:3.10/revert-f646968f8f7c624587de729115d802372b9063dd.patch][3.10]]
  - 3.12
* [  3.10         ] fs/fscache: remove spin_lock() from the condition in while(){C::bug::compile::compiling_err::semantics::remove spin_lock() from the condition in while()}
  + [[file:3.10/fs-fscache-remove-spin_lock-from-the-condition-in-wh.patch][3.10]]
  - 3.12
* [  3.10 -   3.12] x86/mce: fix mce timer interval{C::bug::hwerr::semantics::semantics::fix mce timer interval}
...
* [  3.10 -   3.18] x86/mce: Defer mce wakeups to threads for PREEMPT_RT{C::bug::deadlock::deadlock::semantics::mce: Defer mce wakeups to threads for PREEMPT_RT}
  ...
  - 4.0
* [  3.10 -    4.0] slub: delay ctor until the object is requested{C::performance::preempt::slub: delay ctor until the object is requested}
  ...
  - 4.1
* [  3.10 -    4.0] percpu-rwsem: compile fix{C::bug::compile::compiling_err::semantics::choose the correct function}
  ...
  - 4.1
* [  3.10 -    4.0] timers: prepare for full preemption improve{C::feature::rtsupport::timers: prepare for full preemption improve}
...
* [  3.10 -    4.4] vtime: Split lock and seqcount{C::performance::mutex:: vtime: Split lock and seqcount}
  ...
  - 4.6
* [  3.10 -    4.4] rcu: use simple waitqueues{C::performance::mutex::rcu: Convert RCU's wait-queues into simple waitqueues.}
  ...
  - 4.6
* [  3.10 -    4.6] gpu/i915: don't open code these things{C::bug::hwerr::semantics::semantics::don't open code these things}
...
* [  3.10 -   4.11] workqueue: Use normal rcu{C::performance::mutex:: workqueue: Use normal rcu}
...
* [  3.10 -   4.11] sched/workqueue: Only wake up idle workers if not blocked on sleeping spin lock{C::performance::smallsize::sched/workqueue: Only wake up idle workers if not blocked on
 sleeping spin lock}
...
* [  3.10 -   4.11] kernel/hotplug: restore original cpu mask oncpu/down{C::feature::hotplug::restore original cpu mask oncpu/down}
...
* [  3.10 -   4.11] kernel/cpu: fix cpu down problem if kthread's cpu is going down{C::bug::hang::hardware::hardware::fix cpu down problem if kthread's cpu is going down}
...
* [  3.10 -   4.11] sched: Distangle worker accounting from rqlock{C::maintain::refactor::sched: Distangle worker accounting from rqlock}
...
* [  3.10 -    4.9] idr: Use local lock instead of preempt enable/disable{C::performance::mutex::idr: Use local lock instead of preempt enable/disable}
  ...
  - 4.11
* [  3.10 -   4.11] drm/i915: drop trace_i915_gem_ring_dispatch on rt{C::bug::crash::hardware::hardware:: drm/i915: drop trace_i915_gem_ring_dispatch on rt}
...
* [  3.10 -   4.11] acpi/rt: Convert acpi_gbl_hardware lock back to a raw_spinlock_t{C::bug::crash::hardware::mutex::acpi/rt: Convert acpi_gbl_hardware lock back to a raw_spinlock_t}
...
* [  3.12         ] net: iwlwifi: request only a threaded handler for interrupts{C::performance::irq::net: iwlwifi: request only a threaded handler for interrupts}
...
* [  3.12         ] drm: remove preempt_disable() from drm_calc_vbltimestamp_from_scanoutpos(){C::bug::deadlock::irq::irq::drm: remove preempt_disable() from drm_calc_vbltimestamp_from_scanoutpos()}
  ...
  - 3.14
* [  3.12         ] genirq: Set the irq thread policy without checking CAP_SYS_NICE{C::bug::ctrl_err::semantics::semantics::genirq: Set the irq thread policy without checking CAP_SYS_NICE}
  + [[file:3.12/genirq-Set-the-irq-thread-policy-without-checking-CA.patch][3.12]]
  - 3.14
* [  3.12         ] lockref: disable 64bit cmpxchg optimization on RT{C::feature::rtsupport::lockref: disable 64bit cmpxchg optimization on RT}
  + [[file:3.12/lockref-disable-64bit-cmpxchg-optimization-on-RT.patch][3.12]]
  - 3.14
* [  3.12 -    4.0] simple-wait: rename and export the equivalent of waitqueue_active(){C::maintain::refactor::simple-wait: rename and export the equivalent of waitqueue_active()}
  ...
  - 4.1
* [  3.12 -    4.0] a few open coded completions{C::performance::mutex::fixup_opencoded_completions}
  ...
  - 4.1
* [  3.12 -    4.0] sparc: provide EARLY_PRINTK for SPARC{C::bug::compile::compiling_err::syntax::sparc: provide EARLY_PRINTK for SPARC}
  ...
  - 4.1
* [  3.12 -    4.8] hwlat-detector: Update hwlat_detector to add outer loop detection{C::bug::data_err::semantics::semantics::hwlat-detector: Update hwlat_detector to add outer loop detection}
  ...
  - 4.9
* [  3.12 -    4.8] hwlat-detector: Use thread instead of stop machine{C::performance::preempt::hwlat-detector: Use thread instead of stop machine}
...
* [  3.12 -    4.8] hwlat-detector: Use trace_clock_local if available{C::bug::data_err::order::semantics::hwlat-detector: Use trace_clock_local if available}
  ...
  - 4.9
* [  3.12 -    4.8] hwlat-detector: Don't ignore threshold module parameter{C::bug::data_err::semantics::semantics::hwlat-detector: Don't ignore threshold module parameter}
...
* [  3.12 -   4.11] wait.h: include atomic.h{C::bug::compile::compiling_err::syntax:: wait.h: include atomic.h}
...
* [  3.12 -   4.11] mm: Allow only slub on RT{C::feature::rtsupport:: mm: Allow only slub on RT}
...
* [  3.12 -   4.11] rtmutex: Add RT aware ww locks{C::feature::rtsupport:: rtmutex: Add RT aware ww locks}
...
* [  3.12 -   4.11] md: disable bcache{C::bug::compile::compiling_err::syntax::md: disable bcache}
...
* [  3.14         ] net: gianfar: do not try to cleanup TX packets if they are not done{C::bug::hwerr::hardware::hardware:: net: gianfar: do not try to cleanup TX packets if they
 are not done}
...
* [  3.14         ] rt,sched,numa: Move task_numa_free() to __put_task_struct(), which -rt offloads {C::bug::deadlock::deadlock::semantics::rt,sched,numa: Move task_numa_free() to __put_task_struct()}
  ...
  - 3.18
* [  3.14         ] Revert "x86: Disable IST stacks for debug/int 3/stack fault for PREEMPT_RT"{C::bug::crash::semantics::semantics::Revert "x86: Disable IST stacks for debug/int 3/stack fault for PREEMPT_RT"}
  + [[file:3.14/Revert-x86-Disable-IST-stacks-for-debug-int-3-stack-.patch][3.14]]
  - 3.18
* [  3.14         ] disable lazy preempt on x86-64{C::feature::rtsupport::disable lazy preempt on x86-64}
...
* [  3.14         ] sparc64: convert ctx_alloc_lock raw_spinlock_t{C::bug::data_err::atomicity::mutex::sparc64: convert ctx_alloc_lock raw_spinlock_t}
  ...
  - 3.18
* [  3.14         ] ipv6: some ipv6 statistic counters failed to disable bh{C::bug::data_err::semantics::semantics::ipv6: some ipv6 statistic counters failed to disable bh}
...
* [  3.14 -   3.18] sched: Fix broken setscheduler(){C::bug::rtlatency::sched::sched::sched: Fix broken setscheduler()}
  ...
  - 4.0
* [  3.14 -   3.18] bad return value in __mutex_lock_check_stamp{C::bug::data_err::semantics::semantics::bad return value in __mutex_lock_check_stamp}
  ...
  - 4.0
* [  3.14 -    4.0] kernel/hrtimer: be non-freezeable in cpu_chill(){C::bug::crash::time::semantics::kernel/hrtimer: be non-freezeable in cpu_chill()}
  ...
  - 4.1
* [  3.14 -    4.0] sched: dont calculate hweight in update_migrate_disable(){C::performance::smallsize::sched: dont calculate hweight in update_migrate_disable()}
  ...
  - 4.1
* [  3.14 -    4.0] API cleanup - use local_lock not __local_lock for soft{C::maintain::refactor:: API cleanup - use local_lock not __local_lock for soft}
  ...
  - 4.1
* [  3.14 -    4.0] softirq: make migrate disable/enable conditioned on softirq_nestcnt transition {C::maintain::refactor:: oftirq: make migrate disable/enable conditioned on softirq_nestcnt transition }
...
* [  3.14 -    4.0] irq_work: allow certain work in hard irq context{C::bug::data_err::irq::irq::irq_work: allow certain work in hard irq context}
  ...
  - 4.1
* [  3.14 -    4.0] seqlock: consolidate spin_lock/unlock waiting with spin_unlock_wait{C::maintain::refactor::seqlock: consolidate spin_lock/unlock waiting with spin_unlock_wait}
  ...
  - 4.1
* [  3.14 -    4.0] timer/rt: Always raise the softirq if there's irq_work to be done{C::bug::hang::softirq::softirq::timer/rt: Always raise the softirq if there's irq_work to
 be done}
  ...
  - 4.1
* [  3.14 -    4.0] migrate_disable pushd down in rt_spin_trylock_irqsave{C::maintain::refactor::migrate_disable pushd down in rt_spin_trylock_irqsave}
  ...
  - 4.1
* [  3.14 -    4.0] write_lock migrate_disable pushdown to rt_write_lock{C::maintain::refactor::write_lock migrate_disable pushdown to rt_write_lock}
  ...
  - 4.1
* [  3.14 -    4.0] migrate_disable pushd down in rt_write_trylock_irqsave{C::maintain::refactor::migrate_disable pushd down in rt_write_trylock_irqsave}
  ...
  - 4.1
* [  3.14 -    4.0] allow preemption in recursive migrate_disable call{C::performance::preempt:: allow preemption in recursive migrate_disable call}
...
* [  3.14 -    4.0] rt: Make cpu_chill() use hrtimer instead of msleep(){C::bug::deadlock::deadlock::semantics::rt: Make cpu_chill() use hrtimer instead of msleep()}
  ...
  - 4.1
* [  3.14 -    4.0] rt: Cleanup of unnecessary do while 0 in read/write _lock(){C::maintain::refactor::rt: Cleanup of unnecessary do while 0 in read/write _lock()}
  ...
  - 4.1
* [  3.14 -    4.0] migrate_disable pushd down in atomic_dec_and_spin_lock{C::maintain::refactor::migrate_disable pushd down in atomic_dec_and_spin_lock}
  ...
  - 4.1
* [  3.14 -    4.0] read_lock migrate_disable pushdown to rt_read_lock{C::maintain::refactor::read_lock migrate_disable pushdown to rt_read_lock}
...
* [  3.14 -    4.0] timer: Raise softirq if there's irq_work{C::bug::deadlock::deadlock::semantics::timer: Raise softirq if there's irq_work}
  ...
  - 4.1
* [  3.14 -    4.0] timers: do not raise softirq unconditionally{C::bug::crash::time::semantics::process timer in hardirq context}
...
* [  3.14 -    4.0] rtmutex: use a trylock for waiter lock in trylock{C::bug::deadlock::deadlock::semantics:: rtmutex: use a trylock for waiter lock in trylock}
  ...
  - 4.1
* [  3.14 -    4.0] condition migration_disable on lock acquisition{C::performance::migration::condition migration_disable on lock acquisition}
  ...
  - 4.1
* [  3.14 -    4.0] use local spin_locks in local_lock{C::performance::mutex::use local spin_locks in local_lock}
  ...
  - 4.1
* [  3.14 -    4.1] net: gianfar: Do not disable interrupts{C::performance::irq::net: gianfar: Do not disable interrupts}
...
* [  3.14 -   4.11] sparc64: use generic rwsem spinlocks rt{C::feature::rtsupport::sparc64: use generic rwsem spinlocks rt}
...
* [  3.14 -   4.11] cpu hotplug: Document why PREEMPT_RT uses a spinlock{C::maintain::donothing::cpu hotplug: Document why PREEMPT_RT uses a spinlock}
...
* [  3.14 -   4.11] crypto: Reduce preempt disabled regions, more algos{C::performance::preempt::crypto: Reduce preempt disabled regions, more algos}
...
* [  3.14 -   4.11] rcu: Eliminate softirq processing from rcutree{C::performance::softirq::rcu: Eliminate softirq processing from rcutree}
...
* [  3.14 -   4.11] rcu: make RCU_BOOST default on RT{C::feature::rtsupport::rcu: make RCU_BOOST default on RT}
...
* [  3.18         ] disable preempt lazy on x86-64 {C::feature::rtsupport:: disable preempt lazy on x86-64}
