* [2.6.22         ] i386-pit-stop-only-when-in-periodic-or-oneshot-mode.patch {C::bugfix::PIT malfunction::config err::add an "if" statement to config mode PERIODIC or ONESHOT specificly}
...
* [2.6.22         ] lockstat_bounce.patch {C::feature::statistics::state and measure lock bouncing}
  ...
  - 2.6.23
* [2.6.22         ] module-pde-race-fixes.patch {C::fixbug::crash::order::sync::module reloaded when still need to be use:: add a atomic counter to counting reads and writes in progress}
...
* [2.6.22         ] hrtimer-speedup-hrtimer_enqueue.patch {C::performance::hrtimer::speedup hrtimer_enqueue}
  ...
  - 2.6.23
* [2.6.22         ] acpi-move-timer-broadcast-and-pmtimer-access-before-c3-arbiter-shutdown.patch {C::fixbug::irq::hardware::check ARB_DIS status before reading from ICH deivce}
...
* [2.6.22         ] x86_64-remove-now-useless-hpet-code.patch {C::maintain::refactor::remove code}
  ...
  - 2.6.23
* [2.6.22         ] net/input: fix net/rfkill/rfkill-input.c bug on 64-bit systems {C::fixbug::compile::typo_var::memory::irq flags must be unsigned long}
  + [[file:2.6.22/rfkill-input-fix.patch][2.6.22]]  {MOD::net/rfkill}
  - 2.6.23
* [2.6.22         ] mm-lockless-preempt-fixup.patch {C::fixbug::livelock::livelock::preempt::create/use new functions}
...
* [2.6.22         ] rt-mutex-spinlock-nested-export-fix.patch {C::maintain::refactor::export __spin_lock_irqsave_nested}
  ...
  - 2.6.23
* [2.6.22         ] cpuidle_warning_fix_002.patch {C::fixbug::na::uninit_var::memory}
...
* [2.6.22         ] fork.c-takeover-tasklets-warning-fix.patch {C::maintain::refactor::header file add}
  ...
  - 2.6.23
* [2.6.22         ] s_files-proc-generic-fix.patch {C::fixbug::na::order::sync::advance filevec_add_drain_all()}
...
* [2.6.22         ] sched-cfs-latest.patch {C::maintain::refactor}
  ...
  - 2.6.23
* [2.6.22         ] clockevents-fix-typo-in-acpi_pmc.patch {C::mainain::refactor}
...
* [2.6.22         ] Clockevents remove clockevents_{release,request}_device {C::maintain::refactor::remove clockevents_release/request_device}
  ...
  - 2.6.23
* [2.6.22         ] cpuidle_take2_basic_documentation_for_cpuidle.patch {C::maintain::nothing::documentation added}
...
* [2.6.22         ] cpuidle_governor_ratings_04.patch {C::feature::idle::governor rating scheme}
  ...
  - 2.6.23
* [2.6.22         ] cpuidle_1_bit_field_must_be_unsigned.patch {C::fixbug::na::typo_var::memory::1-bit field must be unsigned}
...
* [2.6.22         ] cpuidle_add_menu_governor.patch {C::feature::idle::add 'menu' governor}
  ...
  - 2.6.23
* [2.6.22         ] new-softirq-code-fixlets.patch {C::fixbug::na::softirq::softirq::a condition err in if statement is fixed & some precompiling code added}
...
* [2.6.22         ] cpuidle_documentation_update_04.patch {C::maintain::donothing::documention}
  ...
  - 2.6.23
* [2.6.22         ] cpuidle_fix_build_break.patch {C::fixbug::compile::config_err::config::fix build break}
...
* [2.6.22         ] x86_64-share-hpet-h.patch {C::maintain::refactor::hpet.h, share same micro var}
  ...
  - 2.6.23
* [2.6.22         ] mm-lockless-preempt-rt-fixup.patch {C::??::cpu_relax, speculate page and check whether ref changed}
...
* [2.6.22         ] cpuidle_add_cpuidle_force_redetect_devices_api.patch {C::feature::idle::add functions}
  ...
  - 2.6.23
* [2.6.22         ] rtc.c-build-fix.patch {C::bugfix::compile::compile_err::config}
...
* [2.6.22         ] keep_proc_acpi_power_around_001.patch {C::feature::timer::add a time interval val to cx->time?}
  ...
  - 2.6.23
* [2.6.22         ] i386-hpet-assumes-boot-cpu-is-0.patch {C::fixbug::crash::hardware::hardware::per_cpu var}
...
* [2.6.22         ] tick-management-spread-timer-interrupt.patch {C::performance::percpu_var::adds an extra offset per cpu so the ticks don't line up,drop lock contention}
  ...
  - 2.6.23
* [2.6.22         ] i386-hpet-check-if-the-counter-works.patch{C::bugfix::hang::hardware::hardware::Verify whether hpet counter works during HPET setup}
...
* [2.6.22         ] cpuidle_export_time_until_next_timer_interrupt_using_no_hz.patch {C::feature::idle::export time until next intr}
  ...
  - 2.6.23
* [2.6.22         ] preempt-realtime-drivers-pci-hotplug.patch {C::performance::lock::rm lock/unlock_kernel}
...
* [2.6.22         ] x86_64-timec-fix-whitespace-wreckage.patch {C::maintain::donothing::rm whitespace}
  ...
  - 2.6.23
* [2.6.22         ] timekeeping-fixup-shadow-variable-argument.patch {C::bugfix::compile::compiling_err::syntax::local var shadows global var}
  + [[file:2.6.22/timekeeping-fixup-shadow-variable-argument.patch][2.6.22]] {MOD::kernel/time}
  - 2.6.23
* [2.6.22         ] cpuidle_ladder_does_not_depend_on_ACPI.patch {C::bugfix::compile::compile_err::syntax}
  + [[file:2.6.22/cpuidle_ladder_does_not_depend_on_ACPI.patch][2.6.22]] {MOD::drivers/cpuidle}
  - 2.6.23
* [2.6.22         ] s_files-per_cpu-rt.patch {C::performance::lock::use get/put_cpu_var_locked to replace get/put_cpu_var}
  + [[file:2.6.22/s_files-per_cpu-rt.patch][2.6.22]] {MOD::fs}
  - 2.6.23
* [2.6.22         ] cpuidle_build_fix_for_not_CPU_IDLE.patch {C::bugfix::compile::config_err::config:: & compilerr?::compile issue when CPU_IDLE is not configured::add precompile}
  + [[file:2.6.22/cpuidle_build_fix_for_not_CPU_IDLE.patch][2.6.22]] {MOD::include/linux}
  - 2.6.23
* [2.6.22         ] cpuidle_fix_sysfs_related_issue.patch {C::fixbug::data_err::var_err::memory::resume/suspend&semantic::complete/wait_for_completion&wrong type}
  + [[file:2.6.22/cpuidle_fix_sysfs_related_issue.patch][2.6.22]] {MOD::drivers/acpi,drivers/cpuidle,include/linux}
  - 2.6.23
* [2.6.22         ] cpuidle_fix_boot_hang.patch {C::fixbug::hang::idle::idle::add detach fun in err path}
...
* [2.6.22         ] x86_64-untangle-asm-hpeth-from-asm-timexh.patch {C::maintain::refactor::compile}
  ...
  - 2.6.23
* [2.6.22         ] s_files-barrier.patch {C::fixbug::data_err::atomicity::mutex::missing files::barrier_lock/unlock}
  + [[file:2.6.22/s_files-barrier.patch][2.6.22]] {MOD::fs,include/linux}
  - 2.6.23
* [2.6.22 - 2.6.23] ich-force-hpet-ich5-fix-a-bug-with-suspend-resume.patch {C::fixbug::idle::hardware::hardware::resume fail::NORT, change site of statement}
...
* [2.6.22 - 2.6.23] i386: prepare sharing the PIT code {C::maintain::refactor::compile}
  ...
  - 2.6.24
* [2.6.22 - 2.6.23] preempt-rt-cs5530-lock-ide-fix.patch{C::fixbug::hang::irq::irq::replace spin_lock_riqsave/irqrestore to local_irq_save/restore}
...
* [2.6.22 - 2.6.24] mips-gtod_clocksource.patch {C::feature::timer::sync time}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] Don't call mcount from vsyscall_fn's {C::fixbug::crash::err_access::semantics::add notrace to vsyscall_fn}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] freeze with mcount_enabled=1 {C::fixbug::hang::deadlock::semantics::atomic_inc/dec tr->disabled}
...
* [2.6.22 - 2.6.24] rcu-classic-fixup.patch{C::feature::rtsupport::add declaration rcu_batches_completed_bh}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] latency-tracer-one-off-fix.patch{C::bugfix::data_err::err_var::semantics::replace \eq with \geq}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] fix clocksource_timebase.shift value{C::bugfix::data_err::config_err::config::call shift with jiffy}
...
* [2.6.22 - 2.6.24] PowerPC: implement read_persistent_clock(){C::maintain::refactor::rename get_boot_time to read_persistent_clock}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] rcu-preempt-fix-rcu-torture.patch{C::performance::add config preempt_rcu}
...
* [2.6.22 - 2.6.24] v2.6.21-rt3{C::maintain::refactor::reorder some code}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] ns2cyc() result fix{C::bugfix::compile::compiling_err::syntax:: warning, wrong type
...
* [2.6.22 - 2.6.24] latency-tracing-remove-trace-array.patch{C::maintain::refactor::rm trace array}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] PowerPC: remove broken vsyscall code{C::bugfix::crash::err_access::semantics::rm broken vsyscalls}
...
* [2.6.22 - 2.6.24] add-notrace.patch{C::feature::debuginfo}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] ppc-a-2.patch{C::fixbug::compile::compiling_err::semantics::replace unknown field}
...
* [2.6.22 - 2.6.24] latency-tracer-printk-fix.patch{C::maintain::refactor}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] IPV6: estalished connections are not shown with "cat /proc/net/tcp6"{C::fixbug::data_err::semantics::semantics::missing out info?::add two var to get val}
...
* [2.6.22 - 2.6.24] [Patch RT] Fix CFS load balancing for RT tasks{C::feature::sched::add queue task rt to enable balance_rt_tasks when overload}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] rcu-3.patch{C::performance::prermpt::preempt read-side critical section}
...
* [2.6.22 - 2.6.24] kvm: make vcpu_load/put preemptible{C::performance::preempt::make vcpu preemptible}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] add might_sleep in rt_spin_lock_fastlock{C::fixbug::hang::atomicity::runtime::might_sleep fun in rt_spin_lock_fastlock}
...
* [2.6.22 - 2.6.24] latency-tracing.patch{C::feature::debuginfo::latency tracing}
  ...
  - 2.6.25
* [2.6.22 - 2.6.25] Fix TASKLET_STATE_SCHED WARN_ON(){C::fixbug::crash::softirq::sync::add an cond-statement}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] percpu-locked-powerpc-fixups-a6.patch{C::fixbug::compile::compiling_err::syntax::add macro def}
...
* [2.6.22 - 2.6.25] powerpc 2.6.21-rt1: rename mcount variable in xmon to xmon_mcount{C::maintain::refactor::raname var}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] handle accurate time keeping over long delays{C::fixbug::data_err::time::semantics::update time been preempted leading to clksrc warp::add var to accumulate}
...
* [2.6.22 - 2.6.25] ep93xx-timer-accuracy.patch{C::performance::hrtimer::improve time of day accuracy}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] rcu-various-fixups.patch{C::fixbug::crash::preempt::preempt::add rcu_read lock pair}
...
* [2.6.22 - 2.6.25] netfilter-more-debugging.patch{C::maintain::refactor::add more debugging}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] preempt-realtime-powerpc-a7.patch{C::fixbug::compile::compiling_err::syntax::replace local_irq_restore with raw_local_irq_restore}
...
* [2.6.22 - 2.6.25] preempt-realtime-supress-cpulock-warning.patch{C::feature::debuginfo::add config}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] More Fixes to TASKLET_STATE_SCHED WARN_ON(){C::fixbug::crash::order::sync::actual bug non exist::add statement}
...
* [2.6.22 - 2.6.25] arm-cmpxchg-support-armv6.patch{C::feature::hardware::support cmpxchg}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] rt-mutex-arm-fix.patch{C::feature::semantics::add attribute}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] arm-fix-atomic-cmpxchg.patch{C::fixbug::deadlock::preempt::replace orig irq_save with raw}
...
* [2.6.22 - 2.6.25] timer patch for ep93xx{C::performance::hardware::add hardware related fun}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] powerpc 2.6.21-rt1: fix kernel hang and/or  panic{C::fixbug::hang::order::order::restore preempt_none method}
...
* [2.6.22 - 2.6.26] fix-emac-locking-2.6.16.patch{C::feature::rtsupport::add spinlock in emac}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt1: fix a build breakage by adding __raw_*_relax() macros{C::fixbug::compile::compiling_err::syntax::add missing macros}
...
* [2.6.22 - 2.6.26] latency-tracing-arm.patch{C::feature::debuginfo::latency tracing arm}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] select-error-leak-fix.patch{C::fixbug::leak::semantics::userspace leak,move label out}
...
* [2.6.22 - 2.6.26] i386-nmi-watchdog-show-regs.patch{C::feature::debuginfo::show reg, rm fun}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] irq nobody cared workaround for i386{C::bugfix::na::hardware::hardware::add fun, an uncared bug fix is mentioned in the mail}
...
* [2.6.22 - 2.6.26] PowerPC: revert fix for threaded fasteoi IRQ handlers{C::maintain::refactor::rm useless field}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] percpu-locked-powerpc-fixups.patch{C::feature::refactor::change macro used}
...
* [2.6.22 - 2.6.26] apic-dumpstack.patch{C::feature::debuginfo::add dump_stack}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] nf_conntrack-fix-smp-processor-id.patch{C::fixbug::data_err::preempt::preempt::replace with raw}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-realtime-powerpc-b3.patch{C::fixbug::runtime warning::get the right cpu_mask}
...
* [2.6.22 - 2.6.26] preempt-irqs-i386-idle-poll-loop-fix.patch{C::performance::idle::cpurelax check resched}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-irqs-ppc-ack-irq-fixups.patch{C::fixbug::crash::hardware::hardware::add field}
...
* [2.6.22 - 2.6.26] preempt-realtime-mips.patch{C::feature::rtsupport::preempt mips}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] (2.6.20-rt3) PowerPC: convert spinlocks into raw{C::featue::rtsupport::replace spinlock with raw}
...
* [2.6.22 - 2.6.26] nmi-profiling.patch{C::feature::rtsupport::replace with raw, add config, notrace}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-realtime-powerpc.patch{C::feature::rtlock}
...
* [2.6.22 - 2.6.26] preempt-realtime-arm-pxa.patch{C::feature::rtsupport::add macros}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] fix-migrating-softirq.patch{C::fixbug::hang::migration::migration::restrict irq migration}
...
* [2.6.22 - 2.6.26] lockstat_bounce_rt.patch{C::performance::mutex::move lock_acquired out}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt6: replace preempt_schedule w/ preempt_schedule_irq User-Agent:{C::fixbug::crash::overflow::irq::irq-entry recursion and stack overflow:: replace...}
...
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt1: convert spinlocks to raw ones for Celleb.{C::feature::rtsupport::replace with raw lock}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-irqs-ppc-fix-b6.patch{C::fixbug::crash::irq::irq::boot warning::set soft/hard enable}
...
* [2.6.22 - 2.6.26] reduce pagetable-freeing latencies{C::performance::preempt::reduce latency}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-realtime-powerpc-b4.patch{C::fixbug::crash::preempt::preempt::preempt_disable added}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-irqs-ppc-fix-b5.patch{C::fixbug::crash::hardware::hardwareLLboot time err,rm field}
...
* [2.6.22 - 2.6.26] latency-measurement-drivers.patch{C::feature::debuginfo::add latency measurement driver}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] mm: lockless pagecache lookups{C::performance::lockless:: pagecache lookup}
...
* [2.6.22 - 2.6.26] preempt-realtime-debug-sysctl.patch{C::feature::debuginfo::add config, add fun, and kinds of field}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-realtime-powerpc-b2.patch{C::fixbug::crash::preempt::preempt::replace with raw}
...
* [2.6.22 - 2.6.26] fix-softirq-checks-for-non-rt-preempt-hardirq.patch{C::maintain::refactor::change config}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] s_files: free_write_pipe() fix{C::fixbug::data_err::order::sync::add cleanup var}
...
* [2.6.22 - 2.6.26] softirq preemption: optimization{C::performance::softirq::allowing hardirq context to pick up softirq processing}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] nf_conntrack-weird-crash-fix.patch{C::fixbug::crash::uninit_var::memory::init per cpu spin_lock}
...
* [2.6.22 - 2.6.26] preempt-realtime-sound.patch{C::feature::debuginfo::invoke user_trace_stop}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] rt-mutex-ppc-fix-a5.patch{C::fixbug::compile::compiling_err::semantics::replace with raw}
...
* [2.6.22 - 2.6.26] percpu-locked-netfilter2.patch{C::feature::rtsupport::lock some percpu var}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] panic-dont-stop-box.patch{C::maintain::other::comment one fun}
...
* [2.6.22 - 2.6.29] patches/preempt-realtime-x86_64.patch{C::feature::add preempt}
  ...
  - 3.0
* [2.6.22 - 2.6.29] floppy: suspend/resume fix{C::fixbug::suspend fails after resume from APM::add fun}
  ...
  - 3.0
* [2.6.22 - 2.6.29] call reboot notifier list when doing an emergency reboot{C::fixbug::hang::add emergency restart}
...
* [2.6.22 - 2.6.29] neptune: no at keyboard{C::feature::??check imput}
  ...
  - 3.0
* [2.6.22 - 2.6.29] net: core preempt fix{C::performance::move fun out of preempt_disable}
...
* [2.6.22 - 2.6.29] preempt: realtime ipc{C::feature::rt::disable preempt, rm some mb}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/rt-kmap-scale-fix.patch{C::fixbug::deadlock::concurrency::keeping a free count & tracking kmap users}
...
* [2.6.22 - 2.6.29] preempt: realtime timer{C::feature::rt::replace with raw and nort, add some fun}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/irda-fix.patch{C::fixbug::dump?::spinlock init after memcpy}
...
* [2.6.22 - 2.6.29] patches/tasklet-redesign.patch{C::maintain::refactor::redesign tasklet}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/random-driver-latency-fix.patch{C::performance::add a extra preempt_enable}
...
* [2.6.22 - 2.6.29] preempt: realtime loopback{C::feature::replace with disable preempt api}
  ...
  - 3.0
* [2.6.22 - 2.6.29] smp: processor id fixups{C::performance::rm preempt disable and replace it with per_cpu_var}
...
* [2.6.22 - 2.6.29] timer: freq tweaks{C::feature::modify dummy fun, add iteration}
  ...
  - 3.0
* [2.6.22 - 2.6.29] gtod: optimize{C::performance::return when jiffies eqs last_tick, maybe kind of refactor i guess}
...
* [2.6.22 - 2.6.29] preempt: realtime console{C::maintain::refactor::add var}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/kprobes-preempt-fix.patch{C::performance::rt::replace preempt_enable_no_resched preempt_enable with each other}
  ...
  - 3.0
* [2.6.22 - 2.6.29] NOHZ: local_softirq_pending with tickless{C::fixbug::::replace fun}
  ...
  - 3.0
* [2.6.22 - 2.6.29] move: native irq{C::fixbug::add init and check}
...
* [2.6.22 - 2.6.29] patches/rt-apis.patch{C::feature::add rt apis}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/preempt-realtime-warn-and-bug-on-fix.patch{C::fixbug::compile err::enclose with __ASSEMBLY__}
...
* [2.6.22 - 2.6.29] replace: bugon by warn on{C::null}
  ...
  - 3.0
* [2.6.22 - 2.6.29] softirq: per cpu assumptions fixes{C::performance::rt::transfer var instead of get it inside the fun, replace with raw}
...
* [2.6.22 - 2.6.29] preempt: irqs i386{C::feature::rt::rt i386}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/ioapic-fix-too-fast-clocks.patch{C::fixbug::??::add upper bound check to avoid clocks to go too fast}
...
* [2.6.22 - 2.6.29] preempt-realtime-arm-bagde4.patch{C::maintain::refactor::reorder code}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/bh-state-lock.patch{C::fixbug::?::add another spinlock to track buffer header}
...
* [2.6.22 - 2.6.29] highmem: redo mainline{C::null::restore flush unused warning} 
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/vortex-fix.patch{C::performance::rt::replace api, rm locks}
...
* [2.6.22 - 2.6.29] preempt: realtime input{C::feature::rt::replace with rt api}
  ...
  - 3.0
* [2.6.22 - 2.6.29] Premmpt-RT: Preevent boosting of idle task{C::fixbug::?::check and avoid boosting?}
