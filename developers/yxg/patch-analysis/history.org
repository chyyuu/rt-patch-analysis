...
* [2.6.22 - 2.6.24] PowerPC: enable HRT and dynticks support{C::feature::idle::enable HRT and dynamic ticks}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] 2.6.21-rt6{C::feature::rtlock::add declaration rt_write_trylock_irqsave}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] rcu-classic-fixup.patch{C::feature::rtlock::add declaration rcu_batches_completed_bh}
...
* [2.6.22 - 2.6.24] rcu-1.patch{C::maintain::refactor::reorganize code}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] dynticks-rcu-rt-fixlet.patch{C:feature::rtlock::check rcu_need_cpu}
...
* [2.6.22 - 2.6.24] trace-name-plus.patch{C::maintain::refactor::modify output info}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] radix-tree: use indirect bit{C::feature::rtlock::indirect rd-tree pointer}
...
* [2.6.22 - 2.6.25] preempt-realtime-supress-cpulock-warning.patch{C::null::add config}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] More Fixes to TASKLET_STATE_SCHED WARN_ON(){C::fixbug::?actual bug non exist::add statement}
...
* [2.6.22 - 2.6.25] timer patch for ep93xx{C::feature::implement fun}
  ...
  - 2.6.26
* [2.6.22 - 2.6.25] powerpc 2.6.21-rt1: fix kernel hang and/or  panic{C::fixbug::hang::restore preempt_none method}
...
* [2.6.22 - 2.6.26] fix-emac-locking-2.6.16.patch{C::feature::add spinlock in emac}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt1: fix a build breakage by adding __raw_*_relax() macros{C::fixbug::build break::add missing macros}
...
* [2.6.22 - 2.6.26] latency-tracing-arm.patch{C::feature::latency tracing arm}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] select-error-leak-fix.patch{C::fixbug::userspace leak::move label out}
...
* [2.6.22 - 2.6.26] preempt-realtime-powerpc-b3.patch{C::fixbug::runtime warning::get the right cpu_mask}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] s_files-schedule_on_each_cpu_wq.patch{C::maintain::refactor&feature::separate a fun, and add sched_on_each_cpu_wq}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] remove global files_lock{C::performance::??}
...
* [2.6.22 - 2.6.26] preempt-irqs-i386-idle-poll-loop-fix.patch{C::feature::cpurelax check resched}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-irqs-ppc-ack-irq-fixups.patch{C::fixbug::crash::add field}
...
* [2.6.22 - 2.6.26] preempt-realtime-arm-pxa.patch{C::feature::add macros}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] fix-migrating-softirq.patch{C::fixbug::hang::restrict irq migration}
...
* [2.6.22 - 2.6.26] lockstat_bounce_rt.patch{C::perf?::move lock_acquired out}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt6: replace preempt_schedule w/ preempt_schedule_irq User-Agent:{C::fixbug::irq-entry recursion and stack overflow:: replace...}
...
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt1: convert spinlocks to raw ones for Celleb.{C::feature::rt::replace with raw lock}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-irqs-ppc-fix-b6.patch{C::fixbug::boot warning::set soft/hard enable}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] reduce pagetable-freeing latencies{C::performance::reduce latency}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-realtime-powerpc-b4.patch{C::fixbug::unexpected preempt? rt::preempt_disable added}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-irqs-ppc-fix-b5.patch{C::fixbug::boot time err::rm field}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] mm: speculative get page{C::performance::speculative get page}
...
* [2.6.22 - 2.6.26] fix-softirq-checks-for-non-rt-preempt-hardirq.patch{C::feature::change config}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] s_files: free_write_pipe() fix{C::fixbug::??::add cleanup var}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] softirq preemption: optimization{C::performance::allowing hardirq context to pick up softirq processing}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] nf_conntrack-weird-crash-fix.patch{C::fixbug::??::init per cpu spin_lock}
...
* [2.6.22 - 2.6.26] preempt-realtime-sound.patch{C::perf?::invoke user_trace_stop}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] rt-mutex-ppc-fix-a5.patch{C::fixbug::compile err::replace with raw}
...
* [2.6.22 - 2.6.26] preempt-realtime-ia64.patch{C::feature::rt::rt ia64}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] powerpc 2.6.21-rt1: reduce scheduling latency by changing tlb flush size{C::performance::pend flush tlb}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] preempt-realtime-profiling.patch{C::performance::rt::add check prof_pid}
...
* [2.6.22 - 2.6.26] percpu-locked-netfilter2.patch{C::feature::rt::lock some percpu var}
  ...
  - 2.6.29
* [2.6.22 - 2.6.26] panic-dont-stop-box.patch{C::performance::?::comment one fun}
