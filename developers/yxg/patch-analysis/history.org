...
* [   3.0         ] proportions: Convert to raw_spinlck{C::feature::rtsupport::replace with raw}
  ...
  - 3.2
* [   3.0         ] drm-more-moronic-crap.patch{C::perf::?degrade performence::rm preempt disable}
...
* [   3.0 -    3.2] sched: Create schedule_preempt_disabled(){C::maintain::refactor::combine three fun together}
  ...
  - 3.4
* [   3.0 -    3.2] timekeeping: Convert xtime_lock to raw_seqlock{C::feature::refactor::replace with raw but not a roll-back}
...
* [   3.0 -    3.6] workqueue-use-get-cpu-light.patch{C::feature::sched::use _light fun to replace? I guess relevant with rt}
  ...
  - 3.8
* [   3.0 -    3.6] x86: kprobes: Remove remove bogus preempt_enable{C::maintain::rm fun not function}
...
* [   3.0 -    3.6] RCU: Force PREEMPT_RCU for PREEMPT-RT{C::feature::rtsupport::rm rt config from tiny rcu to avoid interactive dependency}
  ...
  - 3.8
* [   3.0 -    3.6] x86: highmem: Replace BUG_ON by WARN_ON{C::feature::debug info::change buginfo to warning to get more info}
  ...
  - 3.8
* [   3.0 -    3.6] tty: Do not disable interrupts in put_ldisc on -rt{C::bug::might sleep::irq::irq::add nort to irq_save}
...
* [   3.0 -    3.8] acpi: Do not disable interrupts on PREEMPT_RT{C::feature::rtsupport::replace with _nort, enable interrupt in rt}
  ...
  - 3.10
* [   3.0 -    3.8] seqlock: Remove unused functions{C::maintain::rm unused fun}
...
* [   3.0 -   3.14] serial: 8250: Clean up the locking for -rt{C::maintain::refactor::merge spinlk and irqsave}
  ...
  - 3.18
* [   3.0 -   3.14] USB: Fix the mouse problem when copying large amounts of data{C::bug::hwerr::hardware::::semantic::modify ints var when plug usb}
...
* [   3.0 -   3.14] mm: Replace cgroup_page bit spinlock{C::feature::mm::add spinlock to control pcg&pcm lock}
  ...
  - 3.18
* [   3.0 -   3.14] filemap-fix-up.patch{C::bug::bug err::irq::replace in_atomic in bug on with pagefault_disabled} 
...
* [   3.0 -   3.18] mm: Prepare decoupling the page fault disabling logic{C::feature::mm::add a var to record pagefault_disabled}
  ...
  - 4.0
* [   3.0 -   3.18] core: Do not disable interrupts on RT in res_counter.c{C::bug::unexpected sleep??::irq::irq::replace with nort}
...
* [   3.0 -   3.18] mm: Fixup all fault handlers to check current->pagefault_disable{C::feature::mm::add check pagefault_disable}
  ...
  - 4.0
* [   3.0 -    4.0] migrate-disable-rt-variant.patch{C::maintain::rtsupport::add dummy fun and macros to control migrate in rt}
...
* [   3.0 -    4.0] mm: Remove preempt count from pagefault disable/enable{C::feature::mm::rm preempt count}
  ...
  - 4.1
* [   3.0 -    4.0] local-var.patch{C::maintain::wrap but same name}
...
* [   3.0 -    4.6] timers: Preempt-rt support{C::feature::rtsupport::check trylock, if unsucceed, return expires in 1 ticks}
  ...
  - 4.8
* [   3.0 -    4.6] drivers/net: fix livelock issues{C::bug::livelock::livelock::rm NETDEV_TX_LOCKED macro optimization}
...
* [   3.0 -   4.11] suspend: Prevent might sleep splats{C::bug::might sleep::preempt::semantics::not a fixup, but a way to block mightsleep warning}
...
* [   3.0 -   4.11] md: raid5: Make raid5_percpu handling RT aware{C::bug::might sleep::preempt::preempt::add locks, and replace with _light to keep serialized}
...
* [   3.0 -   4.11] x86: Convert mce timer to hrtimer{C::bug::might sleep::??::timer::convert mce to hrtimer}
...
* [   3.0 -   4.11] x86: Use generic rwsem_spinlocks on -rt{C::feature::capacity::modify config to use gen rwsem in rt}
...
* [   3.0 -   4.11] fs: ntfs: disable interrupt only on !RT{C::bug::dump::irq::irq::replace with nort}
...
* [   3.0 -   4.11] softirq: Disable softirq stacks for RT{C::feature::capacity::disable softirq stack rt}
...
* [   3.0 -    4.9] radix-tree: Make RT aware{C::feature::rtsupport::make radix-tree rt aware}
  ...
  - 4.11
* [   3.0 -   4.11] rtmutex: Avoid include hell{C::bug::compile:compiling_err::compile::correct header file}
...
* [   3.0 -   4.11] timer: delay waking softirqs from the jiffy tick{C::bug::unbalanced sched::irq::semantic::reorder fun}
...
* [   3.0 -   4.11] fs/epoll: Do not disable preemption on RT{C::feature::rt::replace with _light}
...
* [   3.0 -   4.11] jump-label: disable if stop_machine() is used{C::feature::disable jump label in rt}
...
* [   3.2         ] wait-simple: Simple waitqueue implementation{C::feature&performance::waitqueue::implement a slim version of waitqueue}
  ...
  - 3.4
* [   3.2         ] printk: Disable migration instead of preemption{C::bug::sleep::preempt::preempt::replace preempt_disable with migrate_disable}
...
* [   3.2         ] powerpc: Mark IPI interrupts IRQF_NO_THREAD{C::feature::rtsupport::rm irq thread flag}
  ...
  - 3.4
* [   3.2         ] sched: Keep period timer ticking when throttling active{C::bug::timer stop?::time::semantics::keep timer alive}
...
* [   3.2 -    3.4] ring-buffer: Convert reader_lock from raw_spin_lock into spin_lock{C::feature::rtsupport::add fun to converd rdlock to spinlock}
  ...
  - 3.6
* [   3.2 -    3.4] rcu: Fix macro substitution for synchronize_rcu_bh() on RT{C::bug::compile::compile_err::syntax::rm () to make it right type}
...
* [   3.2 -    3.4] workqueue: Use get_cpu_light() in flush_gcwq(){C::feature::rtsupport::replace with _light}
  ...
  - 3.6
* [   3.2 -    3.6] ftrace-crap.patch{C::bug::??::??::semantic::implement a rt version fun}
  + [[file:3.2/ftrace-crap.patch][3.2]]
    [[file:3.4/ftrace-crap.patch][3.4]]
    [[file:3.6/ftrace-crap.patch][3.6]]
  - 3.8
* [   3.2 -    3.6] softirq: Fix unplug deadlock{C::bug::deadlock::deadlock::semantic::add a check, rm some case and a new case to manage dead}
...
* [   3.2 -    3.6] hrtimer-fix-reprogram-madness.patch{C::bug::na::config_err::config::add a config check to avoid fun used but not config}
  ...
  - 3.8
* [   3.2 -    3.6] rt/rcutree: Move misplaced prototype{C::bug::compile::compile_err::semantics::move declaration}
...
* [   3.2 -    3.8] intel_idle: Convert i7300_idle_lock to raw spinlock{C::bug::crash::atomicity::preempt::replace with raw}
  ...
  - 3.10
* [   3.2 -    3.8] printk: Don't call printk_tick in printk_needs_cpu() on RT{C::bug::crash::atomicity::semantic::replace with a sleep safe fun}
  ...
  - 3.10
* [   3.2 -    3.8] x86: hpet: Disable MSI on Lenovo W510{C::bug::crash::hardware::semantic::just add stack to call back on this chip, not a fixup}
  ...
  - 3.10
* [   3.2 -   3.10] softirq: Export in_serving_softirq(){C::bug::compile::compile_err::syntax::add symbol export}
  ...
  - 3.12
* [   3.2 -   3.10] hardirq.h: Define softirq_count() as OUL to kill build warning{C::bug::compile::compile_err::memory::change var type}
...
* [   3.2 -    4.0] sched: Teach migrate_disable about atomic contexts{C::feature::sched::add var to record migrate disable atomic num, and warning}
  ...
  - 4.1
* [   3.2 -    4.0] ipc/mqueue: Add a critical section to avoid a deadlock{C::bug::hang::deadlock::deadlock::preempt::diasble preempt}
  ...
  - 4.1
* [   3.2 -    4.0] sched: Postpone actual migration disalbe to schedule{C::performance::migrate::new impl of migrate disable}
...
* [   3.2 -    4.0] sched: Do not compare cpu masks in scheduler{C::feature::sched::do not compare cpu masks in sched}
  ...
  - 4.1
* [   3.2 -    4.0] sysctl-include-fix.patch{C::bug::compile::compile_err::syntax::add proper header file}
...
* [   3.2 -    4.0] early-printk-consolidate.patch{C::maintain::refactor}
  ...
  - 4.1
* [   3.2 -    4.4] rwlocks: Fix section mismatch{C::bug::compile::compile_err::syntax::making non-rt kernel cache align rwlocks by default}
...
* [   3.2 -   4.11] ARM: Initialize split page table locks for vector page{C::bug::crash::data_err::semantic::add fun}
...
* [   3.2 -   4.11] kgdb/serial: Short term workaround{C::bug::?module unusable::semantic::add fun, and move the cnt}
...
* [   3.2 -    4.9] pci: Use __wake_up_all_locked in pci_unblock_user_cfg_access(){C::feature::rtsupport::add lock to prevent mightsleep}
  ...
  - 4.11
* [   3.2 -   4.11] rt: Improve the serial console PASS_LIMIT{C::bug::compile::compile_err::syntax::add a rt limit}
...
* [   3.2 -   4.11] rcu: Frob softirq test{C::bug::deadlock::deadlock::semantic::add preempt count check}
...
* [   3.4         ] futex/rt: Fix possible lockup when taking pi_lock in proxy handler{C::feature::rtsupport::replace with irq disabled}
  ...
  - 3.6
* [   3.4 -    3.6] rcu: Fix build break{C::bug::compile::compiler_err::syntex::restrict precompile section}
...
* [   3.4 -    4.1] x86: Do not disable preemption in int3 on 32bit{C::feature::rtsupport::do dot disable preempt}
  ...
  - 4.4
* [   3.4 -   4.11] futex: Fix bug on when a requeued RT task times out{C::bug::deadlock::deadlock::semantic::add macro and specific check}
...
* [   3.4 -   4.11] timer-fd: Prevent live lock{C::bug::livelock::livelock::semantic::wait for return before cpu_relax}
