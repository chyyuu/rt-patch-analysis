...
* [2.6.22 - 2.6.29] patches/preempt-realtime-x86_64.patch{C::feature::rtsupport::add preempt}
  ...
  - 3.0
* [2.6.22 - 2.6.29] floppy: suspend/resume fix{C::feature::idle::suspend fails after resume from APM::add fun}
  ...
  - 3.0
* [2.6.22 - 2.6.29] call reboot notifier list when doing an emergency reboot{C::fixbug::hang::preempt::preempt::add emergency restart}
...
* [2.6.22 - 2.6.29] patches/jbd_assertions_smp_only.patch{C::maintain::refactor::unify api when smp or not}
  ...
  - 3.0
* [2.6.22 - 2.6.29] neptune: no at keyboard{C::feature::other::check imput}
...
* [2.6.22 - 2.6.29] preempt: realtime ipc{C::feature::rtsupport::disable preempt, rm some mb}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/rt-kmap-scale-fix.patch{C::fixbug::deadlock::deadlock::semantics::keeping a free count & tracking kmap users}
...
* [2.6.22 - 2.6.29] preempt: realtime timer{C::feature::rtsupport::replace with raw and nort, add some fun}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/irda-fix.patch{C::fixbug::crash::uninit_var::semantics::spinlock init after memcpy}
...
* [2.6.22 - 2.6.29] patches/tasklet-redesign.patch{C::maintain::refactor::redesign tasklet}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/random-driver-latency-fix.patch{C::performance::preempt::add a extra preempt_enable}
...
* [2.6.22 - 2.6.29] patches/serial-locking-rt-cleanup.patch{C::maintain::refactor::unify spin_trylock and irq_save}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/kmap-atomic-prepare.patch{C::feature::preempt::add preempt_enable}
...
* [2.6.22 - 2.6.29] cputimer: thread rt fix{C::maintain::refactor::move codes}
  ...
  - 3.0
* [2.6.22 - 2.6.29] x86_64 GTOD: offer scalable vgettimeofday{C::fixbug::data_err::semantics::scalable vgettimeofday independently of tsc synchronize or not}
...
* [2.6.22 - 2.6.29] patches/kprobes-preempt-fix.patch{C::performance::preempt::replace preempt_enable_no_resched preempt_enable with each other}
  ...
  - 3.0
* [2.6.22 - 2.6.29] NOHZ: local_softirq_pending with tickless{C::fixbug::softirq::softirq::softirq::replace fun}
  ...
  - 3.0
* [2.6.22 - 2.6.29] move: native irq{C::fixbug::irq::irq::irq::add init and check}
...
* [2.6.22 - 2.6.29] patches/rt-apis.patch{C::feature::rtsupport::add rt apis}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/preempt-realtime-warn-and-bug-on-fix.patch{C::fixbug::compile::compiling_err::syntax::enclose with __ASSEMBLY__}
...
* [2.6.22 - 2.6.29] preempt: irqs i386{C::feature::rtsupport::rt i386}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/ioapic-fix-too-fast-clocks.patch{C::fixbug::irq::irq::irq::add upper bound check to avoid clocks to go too fast}
...
* [2.6.22 - 2.6.29] preempt-realtime-arm-bagde4.patch{C::maintain::refactor::reorder code}
  ...
  - 3.0
* [2.6.22 - 2.6.29] patches/bh-state-lock.patch{C::fixbug::deadlock::deadlock::mutex::add another spinlock to track buffer header}
...
* [2.6.22 - 2.6.29] preempt: realtime input{C::feature::rtsupport::replace with rt api}
  ...
  - 3.0
* [2.6.22 - 2.6.29] Premmpt-RT: Preevent boosting of idle task{C::feature::check::check and avoid boosting?}
