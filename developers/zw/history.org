...
* [2.6.23         ] x86_64: use i386 i8253.h {C::maintain::refactor::use i386 include files for x86_64}
  ...
  - 2.6.24
* [2.6.23         ] rt-task-migration.patch {C::??}
...
* [2.6.23         ] x86_64: remove pit synchronization {C::performance::smallsize::remove PIT synchronization}
  ...
  - 2.6.24
* [2.6.23         ] x86_64: remove now unused code {C::performance::smallsize::remove unused code}
...
* [2.6.23         ] x86_64: Add (not yet used) clock event functions {C::feature::timer:: add clock event functions}
  ...
  - 2.6.24
* [2.6.23         ] clockevents: Remove unused inline function {C::performance::smallsize::remove unused inline function}
...
* [2.6.23         ] x86_64: cleanup apic.c after clock events switch {C::maintain::refactor::make variables static}
  ...
  - 2.6.24
* [2.6.23         ] sched-rt-balance-fix.patch {C::bug::hang::order::order::update variable in time}
...
* [2.6.23 - 2.6.24] Compile fix for PREEMPT_TIMING on and TRACE_IRQFLAGS off {C::bug::compile::compiling_err::syntax::add condition for marco}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] mm: prep find_lock_page {C::??}
...
* [2.6.23 - 2.6.24] RCU: preemptible documentation and comment cleanups {C::maintain::refactor::rename marco and documentation}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] RCU: CPU hotplug support for preemptible RCU {C::feature::hardware::allow preemptible RCU to tolerate CPU-hotplug operations}
...
* [2.6.23 - 2.6.24] Compile fix for PREEMPT_TIMING on and IRQSOFF_TIMING off {C::bug::compile::compiling_err::syntax::avoid a compiler warning}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] RCU: Make RCU priority boosting consume less power {C::performance::hardware::explicitly sleep when possible}
...
* [2.6.23 - 2.6.24] time keeping add cycle_raw for actual incrementation {C::bug::data_err::time::semantics::provide an accumulative counter}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] RCU: Fix barriers {C::bug::??::atomicity::mutex::make queueing of callbacks atomic}
...
* [2.6.23 - 2.6.24] spinlocks/rwlocks: use PICK_FUNCTION() {C::maintain::refactor::reaplace PICK_OP with PICK_FUNCTION}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] RCU: Split API to permit multiple RCU implementations {C::maintain::refactor::re-organizes the RCU code}
...
* [2.6.23 - 2.6.24] preempt_max_latency in all modes {C::feature::statistics::enable preempt_max_latency facility for timing modes}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] -rt scheduling: wakeup bug? {C::bug::na::preempt::semantics::move a section of code up}
...
* [2.6.23 - 2.6.24] RCU: Preemptible RCU {C::feature::rtsupport::implement a new version of RCU}
  ...
  - 2.6.25
* [2.6.23 - 2.6.24] fix the softlockup watchdog to actually do something {C::bug::na::semantics::semantics::fix the softlockup watchdog so it reports lockups}
...
* [2.6.23 - 2.6.24] fork: desched_thread comment rework. {C::maintain::refactor::reformat the comment}
  ...
  - 2.6.25
* [2.6.23 - 2.6.25] Fix alternate_node_alloc() on RT kernel {C::bug::na::migration::migration::pass the this_cpu variable to cache_grow()}
...
* [2.6.23 - 2.6.26] just rename call_rcu_bh instead of making it a macro {C::bug::compile::compiling_err::syntax::rename call_rcu_bh to call_rcu_preempt}
  ...
  - 2.6.29
* [2.6.23 - 2.6.26] percpu_list {C::feature::other::give the lock_list a percpu_head}
  ...
  - 2.6.29
* [2.6.23 - 2.6.26] rcupreempt-boost-early-init.patch {C::bug::data_err::semantics::semantics::change return value, add marcos and functions}
...
* [2.6.23 - 2.6.26] Only run softirqs from the irq thread if the irq affinity is set to 1 CPU {C::performance::irq::only run the softirq functions in IRQ thread when safe}
  ...
  - 2.6.29
* [2.6.23 - 2.6.26] mm: spinlock tree_lock {C::bug::na::semantics::semantics::convert the lock from an rwlock to a spinlock}
...
* [2.6.23 - 2.6.26] lockdep_lock_set_subclass_fix.patch {C::bug::data_err::semantics::semantics::check for condition}
  ...
  - 2.6.29
* [2.6.23 - 2.6.26] export-schedule-on-each-cpu.patch {C::maintain::reafactor::export symbol schedule_on_each_cpu}
...
execution of pending interrupts}
  ...
  - 3.0
* [2.6.23 - 2.6.29] WARNING: at kernel/sched.c:5071 2.6.23-rc1-rt7 {C::bug::na::semantics::semantics::change conditional compilation marco}
...
* [2.6.23 - 2.6.29] rt: mutex trivial tcp preempt fix {C::maintain::refactor::replace preempt_enable with preempt_enable_no_resched}
  ...
  - 3.0
* [2.6.23 - 2.6.29] core: make asm/irq_regs.h available on every platform {C::feature::irq::make asm/irq_regs.h available on every platform}
  ...
  - 3.0
* [2.6.23 - 2.6.29] ARM: use raw lock in __new_context {C::bug::na::semantics::mutex::use raw lock in __new_context}
...
* [2.6.24         ] sched: add credits for RT balancing improvements {C::maintain::donothing::add credits for RT balancing improvements}
  ...
  - 2.6.25
* [2.6.24         ] sched: break out search for RT tasks {C::maintaim::refactor::isolate the search logic into a function}
...
* [2.6.24         ] sched: RT balancing: include current CPU {C::maintain::refactor::include current CPU in search}
  ...
  - 2.6.25
* [2.6.24         ] sched: dynamically update the root-domain span/online maps {C::bug::idle::semantics::dynamically update the root-domain span/online maps}
...
* [2.6.24         ] preempt_max_latency to microseconds {C::maintain::refactor::use microseconds instead of cycles}
  ...
  - 2.6.25
* [2.6.24         ] kvm: check need_resched() inside the irq disabled region {C::bug::na::irq::irq::check need_resched() inside the irq_disabled region}
...
* [2.6.24         ] sched: pre-route RT tasks on wakeup {C::feature::sched::optimized low-priority wakeup path}
  ...
  - 2.6.25
* [2.6.24         ] sched: RT-balance, avoid overloading {C::performance::cache::wake RT tasks up on another runqueue when possible}
...
* [2.6.24         ] sched: de-SCHED_OTHER-ize the RT path {C::feature::sched::create a new sched_class interface for pre-wakeup routing decisions}
  ...
  - 2.6.25
* [2.6.24         ] [yanmin_zhang@linux.intel.com: aim7 -30% regression in 2.6.24-rc1] {C::bug::na::semantics::semantics::allocate memory on higher address}
...
* [2.6.24         ] sched: remove leftover debugging {C::performance::smallsize::remove leftover debugging}
  ...
  - 2.6.25
* [2.6.24         ] Revert Softdisable for simple irqs. {C::bug::na::semantics::semantics::reverts the masking in the simple handler}
...
* [2.6.24         ] sched: add RT task pushing {C::feature::sched::algorithm to push extra RT tasks off a runqueue to other CPU runqueues}
  ...
  - 2.6.25
* [2.6.24         ] don't panic on failed bootmem alloc {C::feature::other::don't panic on failed bootmem alloc}
...
* [2.6.24 - 2.6.25] irq-flags-unsigned-long.patch {C::maintain::refactor::convert irq flags to unsigned long}
  ...
  - 2.6.26
* [2.6.24 - 2.6.25] kvm: move the apic timer migration {C::bug::hang::preempt::semantics::move the apic timer migration}
...
* [2.6.24 - 2.6.25] Use real time pcp locking for page draining during cpu unplug {C::bug::crash::irq::mutex::use real time pcp locking for page draining during cpu unplug}
  ...
  - 2.6.26
* [2.6.24 - 2.6.25] kvm: add need_resched_delayed() {C::bug::na::semantics::semantics::loose condition}
  + [[file:2.6.24/kvm-preempt-rt-resched-delayed.patch][2.6.24]]
    [[file:2.6.25/kvm-preempt-rt-resched-delayed.patch][2.6.25]]
  - 2.6.26
* [2.6.24 - 2.6.26] rt: PI-workqueue: propagate prio for delayed work {C::bug::data_err::semantics::semantics::propagate prio for delayed work}
...
* [2.6.24 - 2.6.26] RT: change from raw_spinlock_t to __raw_spinlock_t {C::bug::compile::compiling_err::syntax::change from raw_spinlock_t to __raw_spinlock_t}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] send-nmi-all-preempt-disable.patch {C::bug::na::preempt::preempt::preempt disable}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] rt: PI-workqueue: fix barriers {C::??}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] rt: list_splice2 {C::feature::other::introduce list_splice2{,_tail}()}
...
* [2.6.24 - 2.6.26] don't trace early init functions for ppc32 {C::feature::debuginfo::add notrace}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] rt: PI-workqueue: wait_on_work() fixup {C::bug::na::??}
...
* [2.6.24 - 2.6.26] per_cpu__ppc64_tlb_batch is only for 64 bit {C::bug::compile::compiling_err::syntax::change marcos}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] local_irq_save_nort-in-swap.patch {C::??}
...
* [2.6.24 - 2.6.26] ARM: compile fix for event tracing {C::bug::compile::compiling_err::syntax::change marco}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] Disable running softirqs from hardirqs completely! {C::feature::softirq::disable running softirqs from hardirqs}
...
* [2.6.24 - 2.6.26] rt: plist_head_splice {C::feature::other::merge-sort two plists together}
  ...
  - 2.6.29
* [2.6.24 - 2.6.26] 2.6.24-rc7-rt1 {C::bug::idle::hardware::idle::return directly on single-core CPU}
...
* [2.6.24 - 2.6.26] sched-use-a-2d-bitmap-search-prio-cpu.patch {C::feature::sched::use a 2-d bitmap for searching lowest priority CPU}
  ...
  - 2.6.29
* [2.6.24 - 2.6.29] handle IRQ_PENDING for simple irq handler {C::bug::irq::semantics::semantics::handle IRQ_PENDING for simple irq handler}
...
* [2.6.24 - 2.6.29] drain: all local pages via sched {C::feature::mm::hack around for drain_all_local_pages}
  ...
  - 3.0
* [2.6.24 - 2.6.29] Fix plist initialisation for CONFIG_DEBUG_PI_LIST {C::feature::refactor::change argument type of marco}
...
* [2.6.24 - 2.6.29] Set plist.lock to NULL on PREEMPT_RT {C::maintain::refactor::add conditional compilation marcos}
  ...
  - 3.0
* [2.6.24 - 2.6.29] Fix rt preempt slab NUMA freeing {C::bug::na::migration::migration::keeping this_cpu/node/slabp in sync}
  ...
  - 3.0
* [2.6.24 - 2.6.29] Preemption problem in kernel RT    Patch] {C::??}
  ...
  - 3.0
* [2.6.24 - 2.6.29] rt: sched groups {C::??}
...
* [2.6.25         ] fix-irq-flags-size.patch {C::maintain::refactor::change unsigned int to unsigned long}
  ...
  - 2.6.26
* [2.6.25         ] disable-sched-rt-groups.patch {C::bug::hang::na::semantics::temporary disable sched_rt groups}
  + [[file:2.6.25/disable-sched-rt-groups.patch][2.6.25]]
  - 2.6.26
* [2.6.25         ] ftrace: unlock the mutex on reading failure {C::bug::deadlock::deadlock::semantics::unlock the mutex on reading failure}
...
* [2.6.25         ] ftrace-remove-print-of-max.patch {C::bug::deadlock::deadlock::semantics::remove printks from trace irqsoff}
  ...
  - 2.6.26
* [2.6.25         ] pcounter-percpu-protect.patch {C::bug::data_err::migration::migration::add protection to per_cpu variables in pcounter addition}
...
of ftrace}
  ...
  - 2.6.26
* [2.6.25         ] RESEND: fix cpus_allowed settings {C::bug::na::semantics::semantics::fix cpus_allowed settings}
...
* [2.6.25 - 2.6.26] preempt-trace.patch {C::feature::debuginfo::track preempt disable nesting}
  ...
  - 2.6.29
* [2.6.25 - 2.6.26] genhd-protect-percpu-var.patch {C::bug::data_err::migration::migration::protect use of smp_processor_id in genhd.h with preempt disable}
...
* [2.6.25 - 2.6.26] sched-clock-nmi.patch {C::feature::timer::update sched clock for NMI}
  ...
  - 2.6.29
* [2.6.25 - 2.6.26] ftrace: avoid lockdep recursion {C::bug::na::semantics::semantics::changes local_irq_save to preempt_disable}
...
* [2.6.25 - 2.6.26] event-tracer-syscall-i386.patch {C::feature::debuginfo::hooks into i386 to track event calls}
  ...
  - 2.6.29
* [2.6.25 - 2.6.26] x86_64: send NMI after nmi_show_regs on {C::bug::order::order::order::send NMI after nmi_show_regs on}
...
* [2.6.25 - 2.6.26] Cache calls to pci_find_capability {C::performance::cache::cache calls to pci_find_capability}
  ...
  - 2.6.29
* [2.6.25 - 2.6.26] x86: nmi_watchdog NMI needed for irq_show_regs_callback() {C::bug::order::order::order::change nmi_watchdog fucntion}
...
* [2.6.25 - 2.6.26] cycles-to-ns-trace-fix.patch {C::bug::data_err::time::preempt::preempt disable for getting time}
  ...
  - 2.6.29
* [2.6.25 - 2.6.26] avoid deadlock related with PG_nonewrefs and swap_lock {C::bug::deadlock::deadlock::semantics::add spin_unlock}
...
* [2.6.25 - 2.6.26] preempt-realtime-ftrace.patch {C::feature::rtsupport::preempt realtime ftrace}
  ...
  - 2.6.29
* [2.6.25 - 2.6.29] apic: level smp affinity {C::??}
  ...
  - 3.0
* [2.6.25 - 2.6.29] deadlock on 2.6.24.3-rt3 {C::bug::deadlock::deadlock::semantics::add spin_unlock}
...
* [2.6.25 - 2.6.29] timer:fix build warning in timer.c {C::bug::compile::compiling_err::semantics::add conditional compilation marcos}
  ...
  - 3.0
* [2.6.25 - 2.6.29] aacraid: compat sem {C::??}
  ...
  - 3.0
* [2.6.25 - 2.6.29] fix printk in atomic hack {C::deadlock::deadlock::mutex::skips releasing the lock if in printk - atomic and not the lock owner}
