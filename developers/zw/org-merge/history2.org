...
* [2.6.22         ] x86_64-fix-apic-typo.patch {C::null}
  ...
  - 2.6.23
* [2.6.22         ] i386-remove-volatile-in-apicc.patch {C::refactor::var::remove volatile feature in static int var}
...
* [2.6.22         ] v2.6.21.4-rt11 {C::fixbug::compiling err::add config, GENERIC_TIME is not supported in some arch, leading to compiling error}
  ...
  - 2.6.23
* [2.6.22         ] spinlock-init-cleanup.patch {C::refactor::spin_lock_init}
  + [[file:2.6.22/spinlock-init-cleanup.patch][2.6.22]]  {MOD::drivers/pci}
  - 2.6.23
* [2.6.22         ] x86_64-use-generic-cmos-update.patch {C::refactor::set_rtc_mmss}
...
* [2.6.22         ] cpuidle_take2_hookup_acpi_c-states_driver_with_cpuidle.patch {C::maintain::refactor::establish a united API of acpi_driver, divide the cstate into many functions, make it better readable}
  ...
  - 2.6.23
* [2.6.22         ] ntp-move-the-cmos-update-code-into-ntpc.patch {C::refactor::update_cmos_clock}
...
* [2.6.22         ] x86_64-i8259-remove-useless-forward-declaration.patch {C::refactor::rm fun}
  ...
  - 2.6.23
* [2.6.22         ] x86_64-share-hpet-h.patch {C::restruct::hpet.h, share same micro var}
