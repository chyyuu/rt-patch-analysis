...
* [2.6.26         ] m68knommu_fixes_ontop_of_v2.6.26.patch {C::?}
  ...
  - 2.6.29
* [2.6.26         ] sched-cpupri-hotplug-support.patch {C::bug::oops?::migration::migration::sched: fix cpupri hotplug support}
...
* [2.6.26         ] rtmutex-debug-fix.patch {C::feature::debuginfo::add task_free info}
  ...
  - 2.6.29
* [2.6.26         ]rwlock-prio-fix.patch {C::bug::?::mutex::mutex::rwlock: reset prio on unlocks and wakeups}
  + [[file:2.6.26/rwlock-prio-fix.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] ftrace-document-event-tracer.patch{C::maintain::document:: add  ftrace-document-event-tracer}
...
* [2.6.26         ] multi-reader-account.patch{C::feature::statistics::keeps track of all reader locks that are held for a task}
  ...
  - 2.6.29
* [2.6.26         ] rwlock-slowunlock-mutex-fix2.patch {C::bug::?::semantics::semantics::rt_read_slowunlock:If readers still own this lock, then we need  to update the pi_list too}
...
* [2.6.26         ] powerpc-ftrace-stop-on-oops.patch{C::feature::debuginfo::Stop tracing, when we run into an oops/bug.}
  ...
  - 2.6.29
* [2.6.26         ] preempt-realtime-ftrace-disable-ftraced.patch{C::?}
...
* [2.6.26         ]preempt-irqs-m68knommu-make-timer-interrupt-non-threaded.patch{C::bug::hwerr::irq::hardware::m68knommu: make timer interrupt non threaded}
  ...
  - 2.6.29
* [2.6.26         ] trace-do-not-wakeup-when-irqs-disabled.patch {C::bug::?::irq::irq::trace do not wakeup when irqs disabled in the PREEMPT_RT case.}
...
* [2.6.26         ] trace_hist-divzero.patch {C::performance::smallsize:: reduce the divide operate counts }
  ...
  - 2.6.29
* [2.6.26         ]warn-on-rt-scatterlist.patch {C::?::remove warn on for scatterlist in preempt rt}
  + [[file:2.6.26/warn-on-rt-scatterlist.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] frace-use-tsc.patch{C::bug::?::Use tsc as ftrace clock till we get all the sched_clock fixes in}
...
* [2.6.26         ] rwlocks-default-nr-readers-nr-cpus.patch{C::performance::mutex::Limit the number of readers to number of CPUS by default}
  ...
  - 2.6.29
* [2.6.26         ] multi-reader-limit.patch {C::feature::?::implement reader limit on read write locks}
  + [[file:2.6.26/multi-reader-limit.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] idle2-fix.patch{C::?::nohz: adjust tick_nohz_stop_sched_tick() call of s390 as well}
...
* [2.6.26         ] lockstat-output.patch {C::feature::debuginfo::warn about disabled lock debugging}
  ...
  - 2.6.29
* [2.6.26         ] ftrace-document-update1.patch {C::maintain::document:: ftrace: document updates}
...
* [2.6.26         ] native-sched-clock-booboo.patch {C::bug::compile::compiling_err::syntax::fix return value}
  ...
  - 2.6.29
* [2.6.26         ] trace-eip2ip.patch {C::bug::?::semantics::semantics::change eip to ip}
...
* [2.6.26         ] rwsems-multiple-readers.patch{C::feature::rtsupport::rw_mutex add framework for multi readers on rwsems}
  ...
  - 2.6.29
* [2.6.26         ]rwlock-fixes.patch{C::bug::?::mutex::mutex::rwlock: fix pi_list race conditions} 
...
* [2.6.26 - 2.6.29] adaptive-adjust-pi-wakeup.patch {C::performance::mutex::adjust pi_lock usage in wakeup}
  ...
  - 3.0
* [2.6.26 - 2.6.29]git-ignore-script-lpp.patch {C::maintain::gitignore:: gitignore scripts/testlpp}
  + [[file:2.6.26/git-ignore-script-lpp.patch][2.6.26]]
    [[file:2.6.29/git-ignore-script-lpp.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] sched-wake_up_idle_cpu-rt.patch {C::bug::?::use raw_smp_processor_id() instead of smp_processor_id() }
...
* [2.6.26 - 2.6.29] rtmutex-rearrange.patch {C::maintain::refactor::rearrange rt_spin_lock_slowlock sleeping code}
  ...
  - 3.0
* [2.6.26 - 2.6.29] fix-adaptive-hack.patch{C::bug::?::fix-adaptive-hack}
...
* [2.6.26 - 2.6.29] arm-omap-05.patch{C::bug::deadlock::deadlock::semantics::  ARM: OMAP: remove unnecessary locking in clk_get_rate()}
  ...
  - 3.0
* [2.6.26 - 2.6.29] adaptive-earlybreak-on-steal.patch {C::bug::?::rtmutex: break out early on first run}
...
* [2.6.29         ] rt: page_alloc.c cleanup
  ...
  - 3.0
* [2.6.29         ] disable-maxcpus-for-now.patch{C::?::disable maxcpus configure item}
...
* [2.6.29         ] preempt-rt-x86-pageattr-flush-unused.patch{C::?::disable a function call}
  ...
  - 3.0
* [2.6.29         ] preempt-rt-scatterlist-nort.patch{C::?::do not need to disable irq}
  + [[file:2.6.29/preempt-rt-scatterlist-nort.patch][2.6.29]]
  - 3.0
* [2.6.29         ] fix-erroneous-histogram-stop-warn-on-messages messages{C::feature::check::debuginfo::add type check and debuginfo}
...
* [2.6.29         ] seqlock - fix for both PREEMPT_RT and non PREEMPT_RT{C::feature::rtsupport:: }
  ...
  - 3.0
* [2.6.29         ] rt: mingo kernel_sem fix{C::refactor?::kconfig:: }
...
* [2.6.29         ] pagealloc-cond-resched-rt-only.patch{C::feature::rtsupport:: replace spin_lock with spin_lock_irqsave, spin_unlock with spin_unlock_irqrestore}
  ...
  - 3.0
* [2.6.29         ] pagealloc: reduce lock sections further{C::performance::mm?mutex?::pagealloc: reduce lock sections further}
...
* [2.6.29         ] genirq-warn-on-do-irq.patch{C::feature::debuginfo::genirq-warn-on-do-irq}
  ...
  - 3.0
* [2.6.29         ] cpu-hotplug: vs slab{C::bug::?::preempt::preempt::ix up the slab allocator to be cpu-hotplug safe}
...
* [2.6.29         ] revert-bkl-cleanup.patch {C::maintain::refactor::test_thread_flag}
  ...
  - 3.0
* [2.6.29         ] rt: fix RCU menuconfig{C::bug::?::config_err::rt: fix RCU menuconfig }
...
* [2.6.29         ] lockdep: fix compat_sema_init{C::bug::na::uninit_var::memory::spin_lock_init}
  ...
  - 3.0
* [2.6.29         ] x86-microcode-fix-sysfs-wreckage.patch{C::?::x86-microcode-fix-sysfs-wreckage}
...
* [2.6.29         ] revert-sched-changes.patch{C::feature::rtsupport:: revert-sched-changes}
  ...
  - 3.0
* [2.6.29         ] remove one extra (incorrect) test in mask_ack_irq(){C::bug::?::irq::irq::remove one extra (incorrect) test in mask_ack_irq()}
...
* [2.6.29         ] rtmutex: remove uber optimization{C::?}
  ...
  - 3.0
* [2.6.29         ] rt: xfs fix{C::?::semantics::semantics::XFS still relies on compat semaphore}
...
* [2.6.29         ] net: clean up dev_queue_xmit() code flow{C::maintain::refactor::net: clean up dev_queue_xmit() code}
  ...
  - 3.0
* [2.6.29         ] percpu-locked-netfilter-ecache.patch{C::data_err::atomicity::mutex::add spinlock}
  + [[file:2.6.29/percpu-locked-netfilter-ecache.patch][2.6.29]]
  - 3.0
* [2.6.29         ] add -rt version tag{C::maintain::version:: update version number}
...
* [2.6.29         ] rt: port hardirq threading to CONFIG_SPARSEIRQ{C::feature::rtsupport::rt: port hardirq threading to CONFIG_SPARSEIRQ}
  ...
  - 3.0
* [2.6.29         ] seqlock: make sure that raw_seqlock_t retries readers while writes are pending] {C::bug::livelock::semantic::semantic::seqlock: make sure that raw_seqlock_t retries readers while writes are pending}
  + [[file:2.6.29/seqlock-01-make-sure-that-raw_seqlock-retries.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt-spin-needbreak-fixup.patch{C::bug::livelock::semantic::semantic::rt-spin-needbreak-fixup}
...
* [2.6.29         ] powerpc-rawlocks.patch{C::feature::rtsupport::powerpc-rawlocks}
  ...
  - 3.0
* [2.6.29         ] rtmutex: unify state manipulation{}{C::bug::data_err::semantic::semantic::rtmutex: unify state manipulation}
...
* [2.6.29         ] suppress warning of smp_processor_id use.{C::bug::?::preempt::preempt::use preempt_disable() to supress waring message}
  ...
  - 3.0
* [2.6.29         ] irq: desc init{C::bug::?::semantic::semantic::replace __SPIN_LOCK_UNLOCKED with RAW_SPIN_LOCK_UNLOCKED}
...
* [2.6.29         ] rtmutex: prevent missed wakeups{C::bug::?::semantics::semantics::rtmutex: prevent missed wakeups}
  ...
  - 3.0
* [2.6.29         ] rt: btrfs locking fix/workaround{C::bug::?::atomicity::mutex:: make this function return 0 if in PREEMPT_RT }
  + [[file:2.6.29/preempt-realtime-btrfs-locking-workaround.patch][2.6.29]]
  - 3.0
* [2.6.29         ] patches/fix-net-bug-fixes.patch{C::bug::?}
  + [[file:2.6.29/fix-net-bug-fixes.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rt: fix paravirt spinlocks{C::bug::?::semantics::mutex:: use __raw_spinlock_t instead of raw_spinlock_t}
...
* [2.6.29         ] cpu-hotplug: preemptible page_alloc{C::feature::rtsupport:: preemptible page_alloc}
  ...
  - 3.0
* [2.6.29         ] powerpc-raw-spin-unlock-wait-disable-preemption.patch{C::bug::?::preempt::preempt::powerpc-raw-spin-unlock-wait-disable-preemption}
  + [[file:2.6.29/powerpc-raw-spin-unlock-wait-disable-preemption.patch][2.6.29]]
  - 3.0
* [2.6.29         ] t: fix ipi call lock{C::bug::?::atomicity::semantics::call_function_lock needs to be raw too - it gets called from atomic}
IPI context.
...
* [2.6.29         ] powerpc-percpu-tlb.patch{C::feature::rtsupport::powerpc-percpu-tlb}
  ...
  - 3.0
* [2.6.29         ] rt: no workqueue tracer{C::bug::?::semantics::semantics:: disable-workqueue-tracer-on-preempt-rt to avoid call sleeping function }
...
* [2.6.29         ] rt: serial console fix{C::bug::data_err::atomicity::mutex::rt: serial console fix }
  ...
  - 3.0
* [2.6.29         ] rt: signals struct lock init fix{C::bug::data_error::atomicity::mutex::ignals struct lock init fix}
...
* [2.6.29 -    4.0] posix-timers: Shorten posix_cpu_timers/<CPU> kernel thread names{C::bug::data_err::overflow::semantics::Shorten the softirq kernel thread names because they always overflow the limited comm length, appearing as "posix_cpu_timer" CPU# times.}
  ...
  - 4.1
* [2.6.29 -    4.0] posix-timers: Avoid wakeups when no timers are active{C::performance::timer::posix-timers: Avoid wakeups when no timers are active}
...
* [   3.8         ] timekeeping: Calc stuff once{C::maintain::refactor::timekeeping: Calc stuff once}
  ...
  - 3.10
* [   3.8         ] of: fix recursive locking in of_get_next_available_child(){C::deadlock::deadlock::semantics:: of: fix recursive locking in of_get_next_available_child()}
  + [[file:3.8/0001-of-fix-recursive-locking-in-of_get_next_available_ch.patch][3.8]]
  - 3.10
* [   3.8         ] powerpc/fsl-msi: use a different locklcass for the cascade interrupt{C::deadlock::deadlock::semantics::powerpc/fsl-msi: use a different locklcass for the cascade interrupt}
...
* [   3.8         ] spi/omap-mcspi: check condition also after timeout{C::bug::hwerr::semantics::semantics::spi/omap-mcspi: check condition also after timeout}
  ...
  - 3.10
* [   3.8         ] FIX [1/2] slub: Do not dereference NULL pointer in node_match{C::data_err::err_var::memory::slub: Do not dereference NULL pointer in node_match}
...
* [   3.8 -   3.14] sched: Init idle->on_rq in init_idle(){C::bug::?::sched::sched::Init idle->on_rq in init_idle()}
  ...
  - 3.18
* [   3.8 -   3.14] sched: Check for idle task in might_sleep(){C::bug::?::semantics::semantics::Idle is not allowed to call sleeping functions ever!}
  ...
  - 3.18
* [   3.8 -   3.14] sched: Queue RT tasks to head when prio drops{C::?::sched::sched::sched: Queue RT tasks to head when prio drops}
...
* [   3.8 -   4.11] futex: Ensure lock/unlock symetry versus pi_lock and hash bucket lock{C::bug::?::semantics::sematics::futex: Ensure lock/unlock symetry versus pi_lock and hash bucket lock}
...
* [  3.10         ] net/cpsw: revert f646968f8f7c624587de729115d802372b9063dd{C::bug::hwerr::semantics::semantics::change MARCO}
  ...
  - 3.12
* [  3.10         ] fs/fscache: remove spin_lock() from the condition in while(){C::bug::compile::compiling_err::semantics::semantics::remove spin_lock() from the condition in while()}
...
* [  3.10 -   3.14] net/cpsw: use a lock around source testing{C::bug::hwerr::atomicity::semantics:: use a lock around source testing}
  ...
  - 3.18
* [  3.10 -   3.18] x86/mce: Defer mce wakeups to threads for PREEMPT_RT{C::deadlock::deadlock::semantics::mce: Defer mce wakeups to threads for PREEMPT_RT}
...
* [  3.10 -    4.6] gpu/i915: don't open code these things{C::bug::hwerr::semantics::semantics::don't open code these things}
  ...
  - 4.8
* [  3.10 -   4.11] rt,ntp: Move call to schedule_delayed_work() to helper thread{C::bug::deadlock::irq::sematics::rt,ntp: Move call to schedule_delayed_work() to helper thread}
...
* [  3.10 -    4.9] idr: Use local lock instead of preempt enable/disable{C::performacne::mutex::idr: Use local lock instead of preempt enable/disable}
...
* [  3.10 -   4.11] acpi/rt: Convert acpi_gbl_hardware lock back to a raw_spinlock_t{C::bug::crash::hwerr::mutex::acpi/rt: Convert acpi_gbl_hardware lock back to a raw_spinlock_t}
...
* [  3.12         ] genirq: Set the irq thread policy without checking CAP_SYS_NICE{C::bug::?::semantics::semantics::genirq: Set the irq thread policy without checking CAP_SYS_NICE}
  ...
  - 3.14
* [  3.12         ] lockref: disable 64bit cmpxchg optimization on RT{C::bug::?::semantics::semantics::lockref: disable 64bit cmpxchg optimization on RT}
...
* [  3.12 -    4.8] hwlat-detector: Update hwlat_detector to add outer loop detection{C::bug::data_err::semantics::semantics::hwlat-detector: Update hwlat_detector to add outer loop detection}
  ...
  - 4.9
* [  3.12 -    4.8] hwlat-detector: Use thread instead of stop machine{C::performance::preempthwlat-detector: Use thread instead of stop machine}
...
* [  3.12 -    4.8] hwlat-detector: Don't ignore threshold module parameter{C::bug::data_err::semantics::semantics::hwlat-detector: Don't ignore threshold module parameter}
  ...
  - 4.9
* [  3.12 -   4.11] hrtimer: Move schedule_work call to helper thread{C::deadlock::irq::irq::hrtimer: Move schedule_work call to helper thread}
...
* [  3.14 -    4.1] net: gianfar: Do not disable interrupts{C::performance::irq::net: gianfar: Do not disable interrupts}
  ...
  - 4.4
* [  3.14 -   4.11] fs: jbd2: pull your plug when waiting for space{C::bug::corrupt::fs: jbd2: pull your plug when waiting for space}
