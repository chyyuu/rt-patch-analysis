...
* [2.6.26         ] trace-ktime-scalar.patch{C::maintain::refactor::ftrace: print ktime values in readable form}
  ...
  - 2.6.29
* [2.6.26         ] ppc64-fix-preempt-unsafe-paths-accessing-per_cpu-variables {C::bug::preempt::Fix preempt unsafe paths accessing per_cpu variables}
...
* [2.6.26         ] arm-omap-02.patch {C::bug::compile::compiling_err::syntax::RT: wrap BUILD_CHECK_IRQ_FLAGS}
  ...
  - 2.6.29
* [2.6.26         ] rwlock-protect-reader_lock_count.patch {C::bug::preempt::rwlock protect reader_lock_count}
...
* [2.6.26         ] m68knommu_fixes_ontop_of_v2.6.26.patch {?}
  ...
  - 2.6.29
* [2.6.26         ] sched-cpupri-hotplug-support.patch {C::bug::migration::sched: fix cpupri hotplug support}
...
* [2.6.26         ]  rwlocks-multiple-readers.patch   {C::feature::rtsupport::adds the managment for rwlocks to have multiple readers}
  ...
  - 2.6.29
* [2.6.26         ] radix-tree-lockdep-plus1.patch {C::bug::data_err::semantics::array was off by 1}
...
* [2.6.26         ] ftrace-function-record-nop.patch {C::maintain::refactor::ftrace: define function trace nop}
  ...
  - 2.6.29
* [2.6.26         ] {C::feature::statistics::keeps track of all reader locks that are held for a task}
...
* [2.6.26         ] ftrace-m68knommu-generic-stacktrace-function.patch {C::feature::debuginfo::provides the generic stack trace interface}
  ...
  - 2.6.29
* [2.6.26         ] {C::feature::debuginfo::Stop tracing, when we run into an oops/bug.}
