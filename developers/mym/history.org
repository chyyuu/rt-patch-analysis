...
* [2.6.26         ] rwlock-torture-no-rt.patch {C::bug::compile::compiling_err::syntax::fix torture test to handle non-rt, access undefined struct member }
  ...
  - 2.6.29
* [2.6.26         ] rwlocks-fix-no-preempt-rt.patch {C::bug::?::the addition of RT_RW_READER broke the non PREEMPT_RT case}
  + [[file:2.6.26/rwlocks-fix-no-preempt-rt.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ]rt-rwlock-conservative-locking.patch {C::bug:: ? ::rwlock: be more conservative in locking reader_lock_count}
...
* [2.6.26         ] trace-ktime-scalar.patch{C::maintain::refactor::ftrace: print ktime values in readable form}
  ...
  - 2.6.29
* [2.6.26         ] ppc64-fix-preempt-unsafe-paths-accessing-per_cpu-variables {C::bug::?::preempt::preempt::Fix preempt unsafe paths accessing per_cpu variables}
...
* [2.6.26         ] arm-omap-02.patch {C::bug::compile::compiling_err::syntax::RT: wrap BUILD_CHECK_IRQ_FLAGS}
  ...
  - 2.6.29
* [2.6.26         ] rwlock-protect-reader_lock_count.patch {C::bug::data_err::atomicity::atomicity::rwlock protect reader_lock_count}
...
* [2.6.26         ] rtmutex-debug-fix.patch {C::feature::debuginfo::add task_free info}
  ...
  - 2.6.29
* [2.6.26         ]rwlock-prio-fix.patch {C::bug::?::preempt::rwlock: reset prio on unlocks and wakeups}
...
* [2.6.26         ] multi-reader-account.patch{C::feature::statistics::keeps track of all reader locks that are held for a task}
  ...
  - 2.6.29
* [2.6.26         ] rwlock-slowunlock-mutex-fix2.patch {C::bug::?::preempt::rt_read_slowunlock:If readers still own this lock, then we need  to update the pi_list too}
...
* [2.6.26         ] ftrace-fix-header.patch {C::bug::compile::compiling_err::syntax::add a header file,fix to handle compiling debugging without CONFIG_FTRACE}
  ...
  - 2.6.29
* [2.6.26         ] ftrace-preempt-trace-check.patch {C::bug::data_err?::semantics::ftrace: only trace preempt off with preempt tracer}
...
* [2.6.26         ] ftrace-record-comm-on-ctrl.patch {C::feature::debuginfo::ftrace: record comm on function ctrl change}
  ...
  - 2.6.29
* [2.6.26         ] lockstat-fix-contention-points.patch {C::bug::?::?::lockstat: fix contention points}
...
* [2.6.26         ]preempt-irqs-m68knommu-make-timer-interrupt-non-threaded.patch{C::bug::hwerr::irq::hardware::m68knommu: make timer interrupt non threaded}
  ...
  - 2.6.29
* [2.6.26         ] trace-do-not-wakeup-when-irqs-disabled.patch  {C::bug::?::?::trace do not wakeup when irqs disabled}
...
* [2.6.26         ] rt-mutex-use-inline.patch {C::maintain::refactor::rt-mutex-use-inline }
  ...
  - 2.6.29
* [2.6.26         ] sched-nr-migrate-lower-default-preempt-rt.patch {C::performance::sched::migration::make sched-nr-migrate default value lower }
  + [[file:2.6.26/sched-nr-migrate-lower-default-preempt-rt.patch][2.6.26]]
  - 2.6.29
* [2.6.26         ] rwlocks-default-nr-readers-nr-cpus.patch{C::performance::?::Limit the number of readers to number of CPUS by default}
...
* [2.6.26         ] ftrace-document-update1.patch {C::maintain::document:: ftrace: document updates}
  ...
  - 2.6.29
* [2.6.26         ] ftrace-hotplug-fix.patch {C::bug::crash::hardware::hardware:::hardware::disable the function tracer when bringing up a new CPU.}
...
* [2.6.26         ] lockdep-avoid-fork-waring.patch {C::bug::?::semantics::semantics::The preprocessor condition }
  ...
  - 2.6.29
* [2.6.26         ] rwlock-pi-lock-reader.patch {C::bug::data_err::?::rwlock-pi-lock-reader}
...
* [2.6.26         ] sched-prioritize-non-migrating-rt-tasks.patch{C::feature::rtsupport::sched: prioritize non-migratable tasks over migratable}
  ...
  - 2.6.29
* [2.6.26         ] fix-a-previously-reverted-fix.patch {C::bug::hang::irq::?::preempt_schedule_irq}
...
* [2.6.26         ] native-sched-clock-booboo.patch {C::bug::compile::compiling_err::syntax::fix return value}
  ...
  - 2.6.29
* [2.6.26         ] trace-eip2ip.patch {C::bug::compile::?::syntax:: change eip to ip}
...
* [2.6.26         ] rwsems-multiple-readers.patch{C::feature::rtsupport::rw_mutex add framework for multi readers on rwsems}
  ...
  - 2.6.29
* [2.6.26         ]rwlock-fixes.patch{C::bug::?::race::race::rwlock: fix pi_list race conditions} 
...
* [2.6.26 - 2.6.29] raw-spinlocks-for-nmi-print.patch {C::bug::data_err::atomicity::mutex::change spinlock to be raw spinlock when serializing prints from NMI}
  ...
  - 3.0
* [2.6.26 - 2.6.29] adaptive-adjust-pi-wakeup.patch {C::performance::pi_lock::adjust pi_lock usage in wakeup}
...
* [2.6.26 - 2.6.29]git-ignore-script-lpp.patch {C::maintain::gitignore:: gitignore scripts/testlpp}
  ...
  - 3.0
* [2.6.26 - 2.6.29] sched: wake_up_idle_cpu rt {C::bug::?::use raw_smp_processor_id() instead of smp_processor_id() }
...
* [2.6.26 - 2.6.29] fix-adaptive-hack.patch{C::bug::?::fix-adaptive-hack}
  ...
  - 3.0
* [2.6.26 - 2.6.29] arm-omap-05.patch{C::bug::deadlock::deadlock::  ARM: OMAP: remove unnecessary locking in clk_get_rate()}
...
* [2.6.26 - 2.6.29] adapt-remove-extra-try-to-lock.patch {C::performance::smallsize::remove the extra call to try_to_take_lock}
  ...
  - 3.0
* [2.6.26 - 2.6.29] sched-fix-dequeued-race.patch {C::bug::?::race::sched-fix-dequeued-race}
  + [[file:2.6.26/sched-fix-dequeued-race.patch][2.6.26]]
  m [[file:2.6.29/sched-fix-dequeued-race.patch][2.6.29]]
  - 3.0
* [2.6.26 - 2.6.29] rtmutex-lateral-steal.patch{C::performance::allow rt-mutex lock-stealing to include lateral priority} 
...
* [2.6.26 - 2.6.29] rtmutex-remove-xchg.patch {C::performance::smallsize:: rtmutex - remove double xchg}
  ...
  - 3.0
* [2.6.26 - 2.6.29] revert-preempt-bkl-revert.patch {C::performance::regression::BKL: revert back to the old spinlock implementation}
...
* [2.6.26 - 2.6.29] bz235099-idle-load-fix.patch {C::bug::data_err::semantics::semantics::fix for load average calculation} 
  ...
  - 3.0
* [2.6.26 - 2.6.29]fix-config-debug-rt-mutex-lock-underflow-warnings.patch {C::bug::data_err::atomicity::converts lock_count to a atomic_t}
...
* [2.6.26 - 2.6.29] adaptive-spinlock-lite-v2.patch {C::performance::hrtimer::adaptive spinlocks lite}
  ...
  - 3.0
* [2.6.26 - 2.6.29] nfs-stats-miss-preemption.patch {C::bug::performance regression::preemption::preempt::nfs: fix missing preemption check}
