...
* [2.6.22         ] ntp-move-the-cmos-update-code-into-ntpc-fix-fix.patch {C::restruct::compile}
  ...
  - 2.6.23
* [2.6.22         ] tick-management-spread-timer-interrupt.patch {C::performance::per_cpu var::drop lock contention}
...
* [2.6.22         ] timekeeping-fixup-shadow-variable-argument.patch {C::restruct::function}
  ...
  - 2.6.23
* [2.6.22         ] cpuidle_ladder_does_not_depend_on_ACPI.patch {C::null::kconfig}
  + [[file:2.6.22/cpuidle_ladder_does_not_depend_on_ACPI.patch][2.6.22]] {MOD::drivers/cpuidle}
  - 2.6.23
* [2.6.22         ] rt: convert the filevec primites for -RT {C::performance::use get/put_cpu_var_locked to replace get/put_cpu_var}
...
* [2.6.22         ] x86_64-untangle-asm-hpeth-from-asm-timexh.patch {C::restruct::compile}
  ...
  - 2.6.23
* [2.6.22         ] fs: restore previous sb->s_files iteration semantics {C::fixbug::miss files::barrier_lock/unlock}
...
* [2.6.22 - 2.6.24] change die_chain from atomic to raw notifiers {C::fixbug::not NMI-safe::replace atomic_notifier_call_chain to raw_...}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] PowerPC: fix clockevents for classic CPUs {C::fixbug:: can not clean irq, no stop:: set a postive value}  
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] convert RCU Preempt tasklet into softirq. {C::performance::softirq::use softirq instead of tasklet} 
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] ppc-gtod-support.patch {C::feature::generaic timekeeping}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] undo-latency-tracing-raw-spinlock-hack.patch {C::maintain::compiling err}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] PowerPC: enable HRT and dynticks support {C::feature::dynamic tick}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] 2.6.21-rt6 {C::maintain::compiling err}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] rcu-classic-fixup.patch  {C::maintain::compiling err}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] latency-tracer-one-off-fix.patch {C::maintain::runtime err}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] fix clocksource_timebase.shift value {C::feature::accurate time}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] trace-sti-mwait.patch {C::feature::trace mwait time on sti env}
  + [[file:2.6.22/trace-sti-mwait.patch][2.6.22]]
    [[file:2.6.23/trace-sti-mwait.patch][2.6.23]]
    [[file:2.6.24/trace-sti-mwait.patch][2.6.24]]
  - 2.6.25
* [2.6.22 - 2.6.24] rcu-2.patch {C::performance::softirq:: add RCU_SOFTIEQ}
  + [[file:2.6.22/rcu-2.patch][2.6.22]]
    [[file:2.6.23/rcu-2.patch][2.6.23]]
    [[file:2.6.24/rcu-2.patch][2.6.24]]
  - 2.6.25
* [2.6.22 - 2.6.24] trace-with-caller-addr.patch {C::feature::trace caller hardirq off}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] PowerPC: implement read_persistent_clock() {C::feature::read time::add read_persistent_clock, del get_boot_time}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] rcu-preempt-fix-rcu-torture.patch {C::performance::use XXX instead of XXX_bh::rcu_batches_completed in CONFIG_PREEMPT_RCU}
  ...
  - 2.6.25
* [2.6.22 - 2.6.24] v2.6.21-rt3 {C::maintain::compiling err}
