...
* [   4.0         ] rtmutex.c: Fix incorrect waiter check{C::bug::na::na::mutex::fix waiter check}
...
* [   4.0         ] rt,locking: fix __ww_mutex_lock_interruptible() lockdep annotation{C::maintain::refactor::replace with mutex_acquir_nest()}
  ...
  - 4.1
* [   4.0         ] xfs: Disable percpu SB on PREEMPT_RT_FULL {C::bug::compile::config_err::config::add config}
...
* [   4.0         ] rtmutex: enable deadlock detection in ww_mutex_lock functions{C::feature::check::correct potential deadlock}
  ...
  - 4.1
* [   4.0         ] irq_work: Hide access to hirq_work_list in PREEMPT_RT_FULL{C::performance::smallsize::add #ifdef}
...
* [   4.0 -    4.1] sched/preempt, arm/futex: Disable preemption in UP futex_atomic_op_inuser() expl{}{C::performance::preempt::add preempt disable/enable pairs}
  ...
  - 4.4
* [   4.0 -    4.1] arm64: Mark PMU interrupt IRQF_NO_THREAD{C::maintain::refactor::add IRQF_NO_THREAD}
  ...
  - 4.4
* [   4.0 -    4.1] sched/preempt, arm/futex: Disable preemption in UP futex_atomic_cmpxchg_inatomic{C::performance::preempt::explicit preempt disable/enable}
...
* [   4.0 -    4.1] sched/preempt, MIPS: Properly lock access to the FPU{}{C::maintain::refactor::combination codes}
  ...
  - 4.4
* [   4.0 -    4.1] sched/preempt, mm/kmap, MIPS: Disable preemption in kmap_coherent() explicitly{C::performance::preempt::explicit preempt disable/enable }
...
* [   4.0 -    4.1] sched/preempt, futex: Update comments to clarify that preemption doesn't have to{C::maintain::donothing::update comments}
  ...
  - 4.4
* [   4.0 -    4.1] sched/preempt, futex: Disable preemption in UP futex_atomic_cmpxchg_inatomic() e{C::performance::preempt::explicit preempt disable/enable}
...
* [   4.0 -    4.1] mm, uaccess: trigger might_sleep() in might_fault() with disabled pagefaults{C::bug::deadlock::semantics::semantics::add makro to call __might_faults}
  ...
  - 4.4
* [   4.0 -    4.1] ARM: cmpxchg: define __HAVE_ARCH_CMPXCHG for armv6 and later{C::maintain::refactor::add define}
...
* [   4.0 -    4.1] mmc: sdhci: don't provide hard irq handler{C::performance::irq::push irq handler into the threaded mode}
  ...
  - 4.4
* [   4.0 -    4.1] mm/fault, arch: Use pagefault_disable() to check for disabled pagefaults in the {C::bug::data_err::semantics::semantics::use faulthandler_disable() replaced in_atomic()}
  ...
  - 4.4
* [   4.0 -    4.1] sched/preempt, futex: Disable preemption in UP futex_atomic_op_inuser() explicit{C::performance::mutex::add preempt_disable/enable ensure mutual exclusion}
...
* [   4.0 -    4.1] arm64: Allow forced irq threading{C::feature::arch::add IRQ_FORCED_THREADING config in arm64}
  ...
  - 4.4
* [   4.0 -    4.4] KVM: use simple waitqueue for vcpu->wq {C::feature::sched::use simple waitqueue for vcpu}
  ...
  - 4.6
* [   4.0 -    4.4] block/mq: drop per ctx cpu_lock{C::maintain::refactor::remove per ctx cpu_lock}
  ...
  - 4.6
* [   4.0 -   4.11] sunrpc: Make svc_xprt_do_enqueue() use get_cpu_light(){C::maintain::refactor::conver the get_cpu() to get_cpu_light()}
...
* [   4.0 -   4.11] hotplug: Use set_cpus_allowed_ptr() in sync_unplug_thread(){C::maintain::refactor::rename fun}
...
* [   4.0 -   4.11] cpufreq: drop K8's driver from beeing selected{C::maintain::refactor::add config}
...
* [   4.0 -   4.11] slub: Disable SLUB_CPU_PARTIAL{C::maintain::refactor::add config}
...
* [   4.0 -   4.11] fs/aio: simple simple work{C::maintain::refactor::replace with swork}
...
* [   4.0 -   4.11] x86: UV: raw_spinlock conversion{C::maintain::refactor::rename raw spin lock}
...
* [   4.0 -   4.11] lockdep: selftest: fix warnings due to missing PREEMPT_RT conditionals{C::bug::compile::config_err::config::add ifndef}
...
* [   4.0 -   4.11] sas-ata/isci: dont't disable interrupts in qc_issue handler{C::performance::preempt::use loacl_irq_save_nort() do not disable irq}
...
* [   4.0 -   4.11] thermal: Defer thermal wakups to threads{C::feature::sched::defer thermal wakups}
...
* [   4.0 -   4.11] memcontrol: Prevent scheduling while atomic in cgroup code{C::maintain::refactor::replace with get/put_cpu_light()}
...
* [   4.0 -   4.11] snd/pcm: fix snd_pcm_stream_lock*() irqs_disabled() splats{C::performance::mutex::replace with nort lock}
...
* [   4.0 -   4.11] ARM: enable irq in translation/section permission fault handlers{C::performance::irq::enable irq}
...
* [   4.0 -   4.11] powerpc/kvm: Disable in-kernel MPIC emulation for PREEMPT_RT_FULL{C::maintain::refactor::add !PREEMPT_RT_FULL config}
...
* [   4.0 -   4.11] x86/mce: use swait queue for mce wakeups{C::feature::sched::use swait queue for mce}
...
* [   4.0 -   4.11] KVM: lapic: mark LAPIC timer handler as irqsafe{C::feature::hrtimer::lapic timer handler}
...
* [   4.0 -   4.11] sched/deadline: dl_task_timer has to be irqsafe{C::maintain::refactor::add init timer->irqsafe}
...
* [   4.1         ] futex: Implement lockless wakeups{C::feature::lockless::lockless wakeups}
  + [[file:4.1/0002-futex-Implement-lockless-wakeups.patch][4.1]]
  - 4.4
* [   4.1         ] sched: Implement lockless wake-queues{C::feature::lockless::lockless wakeups queues}
...
* [   4.1         ] futex: avoid double wake up in PI futex wait / wake on -RT{C::performance::mutex::avoid double wake up}
  ...
  - 4.4
* [   4.1         ] mm/slub: move slab initialization into irq enabled region{C::feature::mm::make allocated slab not visible to enable irq}
...
* [   4.1         ] ipc/mqueue: Implement lockless pipelined wakeups{C::feature::lockless:: lockless pipelined wakeup}
  ...
  - 4.4
* [   4.1 -   4.11] Intrduce migrate_disable() + cpu_light(){C::feature::hardware::add migrate_disable and cpu_light()}
...
* [   4.1 -   4.11] i915: bogus warning from i915 when running on PREEMPT_RT{C::maintain::refactor::rename function}
...
* [   4.1 -   4.11] irqwork: push most work into softirq context{C::performance::softirq::push most work into softirq context }
...
* [   4.1 -   4.11] powerpc: ps3/device-init.c - adapt to completions using swait vs wait{C::maintain::refactor::replace with swait}
...
* [   4.4         ] ARM: OMAP2: Drop the concept of certain power domains not being able to lose context {C::maintain::refactor::drop the concept of some power domains code}
  + [[file:4.4/0009-ARM-OMAP2-Drop-the-concept-of-certain-power-domains-.patch][4.4]]
  - 4.6
* [   4.4         ] mm/rmap: retry lock check in anon_vma_free(){C::feature::mm::add retry lock check , msleep()}
  + [[file:4.4/mm-rmap-retry-lock-check-in-anon_vma_free.patch_vma_free.patch][4.4]]
  - 4.6
* [   4.4 -    4.6] rtmutex: Use chainwalking control enum{C::maintain::refactor::refactor function}
...
* [   4.4 -    4.8] ipc/msg: Implement lockless pipelined wakeups{C::feature::lockless::lockless pipelined wakeups}
  ...
  - 4.9
* [   4.4 -    4.8] dump stack: don't disable preemption during trace{C::bug::hang::preempt::preempt::replace with get_cpu_light(),migrate_disable()}
  ...
  - 4.9
* [   4.4 -   4.11] arm64/xen: Make XEN depend on !RT{C::maintain::refactor::add !PREEMPT_RT_FULL config for xen}
...
* [   4.4 -   4.11] latency_hist: Update sched_wakeup probe{C::maintain::refactor::remove success}
...
* [   4.4 -   4.11] locking: locktorture: Do NOT include rwlock.h directly{C::maintain::refactor::remove header file}
...
* [   4.4 -   4.11] ARM: smp: Move clear_tasks_mm_cpumask() call to __cpu_die(){C::bug::hang::semantics::semantics::Move clear_tasks_mm_cpumask() call to __cpu_die()}
...
* [   4.4 -   4.11] hrtimer: enfore 64byte alignment{C::maintain::refactor::remove HRTIMER_CLOCK_BASE_ALIGN compile}
...
* [   4.4 -   4.11] rtmutex: trylock is okay on -RT{C::feature::debuginfo::add WARN_ON}
...
* [   4.4 -   4.11] pid.h: include atomic.h{C::maintain::refactor::add header file}
...
* [   4.4 -   4.11] irqwork: Move irq safe work to irq context{C::bug::softirq::softirq::order::Move irq safe work to irq context}
...
* [   4.4 -   4.11] x86/signal: delay calling signals on 32bit{C::maintain::refactor::remove compiling condition}
...
* [   4.4 -   4.11] rbtree: don't include the rcu header{C::maintain::refactor::move RCU header from header file into c file}
...
* [   4.6         ] sched: use tsk_cpus_allowed() instead of accessing ->cpus_allowed{C::maintain::refactor::use tsk_cpus_allowed() instead of cpus_allowed()}
  ...
  - 4.8
* [   4.6         ] ARM: imx: always use TWD on IMX6Q{C::maintain::refactor::add config}
...
* [   4.6         ] infiniband/ulp/ipoib: remove pkey_mutex{C::maintain::refactor::remove pkey_mutex}
  ...
  - 4.8
* [   4.6         ] rcu: disable more spots of rcu_bh{C::performance::smallsize::add #ifndef}
  + [[file:4.6/rcu-disable-more-spots-of-rcu_bh.patch][4.6]]
  - 4.8
* [   4.6         ] arm+arm64: lazy-preempt: add TIF_NEED_RESCHED_LAZY to _TIF_WORK_MASK{C::maintain::refactor::add compile condition }
...
* [   4.6         ] preempt-lazy: Add the lazy-preemption check to preempt_schedule(){C::feature::check::Add the lazy-preemption check to preempt_schedule()}
  ...
  - 4.8
* [   4.6         ] sched: provide a tsk_nr_cpus_allowed() helper{C::maintain::refactor}
  + [[file:4.6/sched-provide-a-tsk_nr_cpus_allowed-helper.patch][4.6]]
  - 4.8
* [   4.6         ] rcu/torture: Comment out rcu_bh ops on PREEMPT_RT_FULL{C::maintain::donothing::Comment out rcu_bh ops on PREEMPT_RT_FULL}
  + [[file:4.6/rcutorture-comment-out-rcu_bh-ops-on-PREEMPT_RT_FULL.patch][4.6]]
  - 4.8
* [   4.6         ] rtmutex: push down migrate_disable() into rt_spin_lock(){C::maintain::refactor}
  + [[file:4.6/rtmutex-push-down-migrate_disable-into-rt_spin_lock.patch][4.6]]
  - 4.8
* [   4.6 -    4.8] locking/lglocks: Use preempt_enable/disable_nort() in lg_double_[un]lock{C::maintain::refactor::replace with _nort()}
  ...
  - 4.9
* [   4.6 -    4.8] mm/zsmalloc: Use get/put_cpu_light in zs_map_object()/zs_unmap_object(){C::maintain::refactor::Use get/put_cpu_light}
  ...
  - 4.9
* [   4.6 -    4.8] net: Make synchronize_rcu_expedited() conditional on !RT_FULL{C::maintain::refactor::forbid synchronize_rcu_expedited() on RT_FULL}
  ...
  - 4.9
* [   4.6 -   4.11] mm: rt: Fix generic kmap_atomic for RT{C::bug::crash::na::preempt::got converted to the _nort() variant}
...
* [   4.6 -   4.11] net/core: protect users of napi_alloc_cache against reentrance{C::bug::corrupt::atomicity::mutex::uses a local lock}
...
* [   4.6 -   4.11] rt/locking: Reenable migration accross schedule{C::bug::deadlock::order::order::Reenable migration accross schedule}
...
* [   4.6 -   4.11] net: move xmit_recursion to per-task variable on -RT{C::feature::debuginfo::moves the counter to per task instead xmit_recursion}
...
* [   4.6 -   4.11] iommu/amd: Use WARN_ON_NORT in __attach_device(){C::maintain::refactor::use WARN_ON_NONRT() to remove warning}
...
* [   4.6 -   4.11] tick/broadcast: Make broadcast hrtimer irqsafe{C::performance::hrtimer::add irqsafe = true}
...
* [   4.6 -   4.11] rtmutex: Handle non enqueued waiters gracefully{C::bug::crash::semantics::semantics::add and change if_condition}
...
* [   4.6 -   4.11] KVM: arm/arm64: downgrade preempt_disable()d region to migrate_disable(){C::feature::rtsupport::add preemptible region}
...
* [   4.6 -   4.11] drm,i915: Use local_lock/unlock_irq() in intel_pipe_update_start/end(){C::maintain::refactor::replace local_irq_enable with local_unlock_irq()}
...
* [   4.6 -    4.9] sc16is7xx: Drop bogus use of IRQF_ONESHOT{C::bug::deadlock::na::irq::remove IRQF_ONESHOT parameter}
  ...
  - 4.11
* [   4.6 -   4.11] ptrace: don't open IRQs in ptrace_freeze_traced() too early{C::performance::irq::add flags parameter to delayed opening interrupt}
...
* [   4.6 -   4.11] clockevents/drivers/timer-atmel-pit: fix double free_irq{C::bug::irq::irq::irq::fix double free_irq}
...
* [   4.6 -   4.11] list_bl: fixup bogus lockdep warning{C::bug::data_err::semantics::semantics::prevent the lockdep class object share}
...
* [   4.6 -   4.11] trace/latency-hist: Consider new argument when probing the sched_switch tracer{C::maintain::refactor::add var}
...
* [   4.6 -   4.11] kernel: softirq: unlock with irqs on{C::bug::irq::irq::irq::add local_irq_enable/disable pairs}
...
* [   4.6 -   4.11] drivers/block/zram: Replace bit spinlocks with rtmutex for -rt{C::feature::rtsupport::Replace bit spinlocks with rtmutex }
...
* [   4.6 -   4.11] mm: backing-dev: don't disable IRQs in wb_congested_put(){C::feature::mm::add irq region}
...
* [   4.6 -   4.11] trace: Use rcuidle version for preemptoff_hist trace point{C::bug::data_err::semantics::semantics::replace trace_preempt_off to rcuidle}
...
* [   4.6 -   4.11] net: dev: always take qdisc's busylock in __dev_xmit_skb(){C::bug::hang::preempt::mutex::add busylock}
...
* [   4.6 -   4.11] arm: at91: do not disable/enable clocks in a row{C::performance::hrtimer::disable/enable clock one line later to avoid needless warning}
...
* [   4.6 -   4.11] net: provide a way to delegate processing a softirq to ksoftirqd{C::feature::sched::provide a way raises the softirq in the ksoftird}
...
* [   4.6 -   4.11] latencyhist: disable jump-labels{C::maintain::refactor::add config}
...
* [   4.6 -    4.9] kernel: migrate_disable() do fastpath in atomic & irqs-off{C::maintain::refactor::refactor migrate_enable/disable}
  ...
  - 4.11
* [   4.6 -   4.11] tty: serial: 8250: don't take the trylock during oops{C::bug::crash::semantics::semantics::skip the trylock in the oops}
...
* [   4.6 -   4.11] softirq: split timer softirqs out of ksoftirqd{C::bug::softirq::softirq::softirq::split timer softirqs out of ksoftirqd}
...
* [   4.6 -   4.11] kernel/perf: mark perf_cpu_context's timer as irqsafe{C::feature::debuginfo::set irqsafe to remove warning info}
...
* [   4.6 -   4.11] drm,radeon,i915: Use preempt_disable/enable_rt() where recommended{}{C::performance::preempt::add preempt_disable/enable_rt()}
...
* [   4.8         ] mm: filemap: fix mapping->nrpages double accounting in fuse{C::bug::data_err::err_var::memory::remove nrpages}
...
* [   4.8         ] mm: filemap: don't plant shadow entries without radix tree node{C::bug::leak::err_var::memory}
  ...
  - 4.9
* [   4.8 -   4.11] rbtree: include rcu.h because we use it{C::maintain::refactor::add header file}
...
* [   4.8 -   4.11] net: add a lock around icmp_sk(){C::feature::rtsupport::add lock avoid missing serialization}
...
* [   4.8 -   4.11] fs/dcache: init in_lookup_hashtable{C::bug::data_err::uninit_var::memory::in_lookup_hashtable}
...
* [   4.8 -   4.11] mm: perform lru_add_drain_all() remotely{C::bug::leak::overflow::memory::drain the LRU pagevecs of remote CPUs}
...
* [   4.8 -   4.11] timer: make the base lock raw{C::feature::rtsupport::replace with raw}
...
* [   4.8 -    4.9] kernel/futex: don't deboost too early{C::bug::livelock::livelock::order::do unlock without deboost and deboost after wake up waiter}
  ...
  - 4.11
* [   4.8 -   4.11] iommu/vt-d: don't disable preemption while accessing deferred_flush(){C::feature::rtsupport::don't disable preemption while accessing deferred_flush()}
...
* [   4.8 -    4.9] gpu: don't check for the lock owner.{C::feature::debuginfo::don't check for the lock owner}
...
* [   4.8 -    4.9] fs/dcache: include wait.h{C::maintain::refactor::include wait.h}
  + [[file:4.8/fs-dcache-include-wait.h.patch][4.8]]
    [[file:4.9/fs-dcache-include-wait.h.patch][4.9]]
  - 4.11
* [   4.8 -   4.11] locallock: add local_lock_on(){C::feature::rtsupport::add local_lock_on()}
...
* [   4.9 -   4.11] locking/percpu-rwsem: Remove preempt_disable variants{C::performance::preempt::remove preempt_disable variants}
  + [[file:4.9/peterz-percpu-rwsem-rt.patch][4.9]]
    [[file:4.11/peterz-percpu-rwsem-rt.patch][4.11]]
* [   4.9 -   4.11] net: Have __napi_schedule_irqoff() disable interrupts on {C::maintain::refactor::add config,refactor function}
...
* [   4.9 -   4.11] drivers/zram: Don't disable preemption in zcomp_stream_get/put(){C::bug::irq::preempt::preempt::add new lock , reorder lock order}
...
* [   4.9         ] btrfs: drop trace_btrfs_all_work_done() from normal_work_helper(){C::feature::debuginfo::remove code}
  + [[file:4.9/btrfs-drop-trace_btrfs_all_work_done-from-normal_wor.patch][4.9]]
  - 4.11
* [   4.9 -   4.11] kernel/sched: move stack + kprobe clean up to __put_task_struct(){C::maintain::refactor::reorder code}
...
* [   4.9         ] locking/percpu-rwsem: use swait for the wating writer{C::performance::mutex::replace with swait}
...
* [   4.9         ] rcu: update: make RCU_EXPEDITE_BOOT default{C::maintain::refactor::change config to make RCU_EXPEDITE_BOOT default}
  ...
  - 4.11
* [   4.9         ] btrfs: swap free() and trace point in run_ordered_work(){C::maintain::refactor::reorder}
...
* [   4.9         ] x86/apic: get rid of "warning: 'acpi_ioapic_lock' defined but not used"{C::feature::debuginfo::add #ifdef to remove warning}
...
* [   4.9 -   4.11] arm: kprobe: replace patch_lock to raw lock{C::bug::deadlock::atomicity::mutex::replace with raw lock}
...
* [  4.11         ] sched/clock: Fix early boot preempt assumption in __set_sched_clock_stable{C::bug::crash::atomicity::preempt::add lock to disable preempt}
  + [[file:4.11/0001-sched-clock-Fix-early-boot-preempt-assumption-in-__s.patch][4.11]]
* [  4.11         ] sched/core: Enable might_sleep() and smp_processor_id() checks early{C::feature::debuginfo::enable might_sleep()and smp_processor_id() checks}
  + [[file:4.11/0017-sched-core-Enable-might_sleep-and-smp_processor_id-c.patch][4.11]]
* [  4.11         ] sched: Remove TASK_ALL{C::maintain::refactor::remove code}
  + [[file:4.11/sched-Remove-TASK_ALL.patch][4.11]]
* [  4.11         ] ia64/topology: Remove cpus_allowed manipulation{C::feature::hardware::remove cpus_allowed-manipulation}
  + [[file:4.11/0001-ia64-topology-Remove-cpus_allowed-manipulation.patch][4.11]]
* [  4.11         ] random: avoid preempt_disable()ed section{C::bug::hang::semantics::preempt::replace sleeping lock with local lock}
...
* [  4.11         ] x86/smp: Adjust system_state check{C::feature::debuginfo::change condition of if to adjust system_state check}
  + [[file:4.11/0004-x86-smp-Adjust-system_state-check.patch][4.11]]
* [  4.11         ] drm/i915: init spinlock properly on -RT{C::feature::rtsupport::add rt-lock init}
  + [[file:4.11/drm-i915-init-spinlock-properly-on-RT.patch][4.11]]
* [  4.11         ] powerpc/smp: Replace open coded task affinity logic{C::performance::smallsize::replace with work_on_cpu_safe()}
  + [[file:4.11/0005-powerpc-smp-Replace-open-coded-task-affinity-logic.patch][4.11]]
* [  4.11         ] sched/deadline/rtmutex: Dont miss the dl_runtime/dl_period update{C::feature::sched::add !dl_prio() condition to force deadline task not out}
  + [[file:4.11/0003-sched-deadline-rtmutex-Dont-miss-the-dl_runtime-dl_p.patch][4.11]]
* [  4.11         ] futex,rt_mutex: Provide futex specific rt_mutex API{C::performance::mutex::remove unnecessary function for rt_mutex}
...
* [  4.11         ] mm: Adjust system_state check{C::feature::check::change condition to handle extra states}
  + [[file:4.11/0008-mm-Adjust-system_state-check.patch][4.11]]
* [  4.11         ] cpuset: Convert callback_lock to raw_spinlock_t{C::feature::rtsupport::replace with raw}
  + [[file:4.11/cpuset-Convert-callback_lock-to-raw_spinlock_t.patch][4.11]]
* [  4.11         ] printk: Adjust system_state checks{C::feature::check::change condition to handle extra states}
  + [[file:4.11/0014-printk-Adjust-system_state-checks.patch][4.11]]
* [  4.11         ] lockdep: Fix compilation error for !CONFIG_MODULES and !CONFIG_SMP{C::bug::compile::compiling_err::config::add function for both cases}
  + [[file:4.11/lockdep-Fix-compilation-error-for-CONFIG_MODULES-and.patch][4.11]]
* [  4.11         ] async: Adjust system_state checks{C::feature::check::change condition to handle extra states}
  + [[file:4.11/0012-async-Adjust-system_state-checks.patch][4.11]]
* [  4.11         ] cpu/hotplug: Use stop_machine_cpuslocked() in takedown_cpu(){C::bug::na::hardware::hardware::replace with _cpuslocked()}
  + [[file:4.11/0017-cpu-hotplug-Use-stop_machine_cpuslocked-in-takedown_.patch][4.11]]
* [  4.11         ] arm64: Adjust system_state check{C::feature::check::change condition to handle extra states}
  + [[file:4.11/0003-arm64-Adjust-system_state-check.patch][4.11]]
* [  4.11         ] futex: Fix small (and harmless looking) inconsistencies{C::maintain::refactor::fix small inconsisten}
  + [[file:4.11/0002-futex-Fix-small-and-harmless-looking-inconsistencies.patch][4.11]]
* [  4.11         ] ACPI/processor: Use cpu_hotplug_disable() instead of get_online_cpus(){C::feature::check::replace with cpu_hotplug_disable() to add lockdep}
  + [[file:4.11/0022-ACPI-processor-Use-cpu_hotplug_disable-instead-of-ge.patch][4.11]]
* [  4.11         ] s390/kernel: Use stop_machine_cpuslocked(){C::bug::na::hardware::hardware::replace with _cpuslocked()}
  + [[file:4.11/0015-s390-kernel-Use-stop_machine_cpuslocked.patch][4.11]]
* [  4.11         ] perf/x86/intel: Drop get_online_cpus() in intel_snb_check_microcode(){C::maintain::refactor::reorder get_online_cpus(),refactor *_online_cpus}
  + [[file:4.11/0019-perf-x86-intel-Drop-get_online_cpus-in-intel_snb_che.patch][4.11]]
* [  4.11         ] char/random: don't print that the init is done{C::feature::debuginfo::remove or delay printf info}
...
* [  4.11         ] kprobes: Cure hotplug lock ordering issues{C::bug::deadlock::order::order::reorder lock}
  + [[file:4.11/0025-kprobes-Cure-hotplug-lock-ordering-issues.patch][4.11]]
* [  4.11         ] lockdep: Fix per-cpu static objects{C::performance::percpu_var::Fix per-cpu static objects}
  + [[file:4.11/lockdep-Fix-per-cpu-static-objects.patch][4.11]]
* [  4.11         ] ACPI/processor: Fix error handling in __acpi_processor_start(){C::bug::leak::semantics::semantics::add return info}
  + [[file:4.11/0007-ACPI-processor-Fix-error-handling-in-__acpi_processo.patch][4.11]]
* [  4.11         ] crypto: N2 - Replace racy task affinity logic{C::bug::crash::hardware::hardware::replace with work_on_cpu_safe()}
  + [[file:4.11/0013-crypto-N2-Replace-racy-task-affinity-logic.patch][4.11]]
* [  4.11         ] Revert "random: invalidate batched entropy after crng init"{C::feature::other::revert random}
  + [[file:4.11/Revert-random-invalidate-batched-entropy-after-crng-.patch][4.11]]
* [  4.11         ] sched/rtmutex/deadline: Fix a PI crash for deadline tasks{C::bug::deadlock::atomicity::mutex::add function and pointer}
...
* [  4.11         ] acpi/processor: Prevent cpu hotplug deadlock{C::bug::deadlock::order::order::check per cpu thread and invoke function directly}
...
* [  4.11         ] futex: Rework futex_lock_pi() to use rt_mutex_*_proxy_lock(){C::bug::na::atomicity::mutex::rework futex_lock_pi()}
  + [[file:4.11/0011-futex-Rework-futex_lock_pi-to-use-rt_mutex_-_proxy_l.patch][4.11]]
* [  4.11         ] _cpuslocked(){C::feature::rtsupport::provide _cpuslocked}
  + [[file:4.11/0003-cpu-hotplug-Provide-cpuhp_setup-remove_state-_nocall.patch][4.11]]
* [  4.11         ] cpufreq/pasemi: Adjust system_state check{C::feature::check::change condition to handle extra states}
  + [[file:4.11/0009-cpufreq-pasemi-Adjust-system_state-check.patch][4.11]]
* [  4.11         ] cpu/hotplug: Provide lockdep_assert_cpus_held(){C::maintain::refactor::add two function assert}
  + [[file:4.11/0002-cpu-hotplug-Provide-lockdep_assert_cpus_held.patch][4.11]]
* [  4.11         ] CPUFREQ: Loongson2: drop set_cpus_allowed_ptr(){C::maintain::refactor::remove code}
...
* [  4.11         ] cpu/hotplug: Convert hotplug locking to percpu rwsem{C::feature::rtsupport::replace with percpu_rwsem}
  + [[file:4.11/0029-cpu-hotplug-Convert-hotplug-locking-to-percpu-rwsem.patch][4.11]]
* [  4.11         ] KVM/PPC/Book3S HV: Use cpuhp_setup_state_nocalls_cpuslocked(){C::feature::rtsupport::use _cpuslocked() to avoid nested call,replace with cpus_read_lock()}
...
* [  4.11         ] rtmutex: Fix PI chain order integrity{C::bug::corrupt::na::semantics::copy deadline,reorder it along prio}
  + [[file:4.11/0007-rtmutex-Fix-PI-chain-order-integrity.patch][4.11]]
* [  4.11         ] futex: workaround migrate_disable/enable in different context{C::performance::mutex::in automic/!atomic contex use respective migrate_disable/enable}
  + [[file:4.11/futex-workaround-migrate_disable-enable-in-different.patch][4.11]]
* [  4.11         ] sched,tracing: Update trace_sched_pi_setprio(){C::maintain::refactor::refactor Numerical priority and fixing sched tracepoints}
  + [[file:4.11/0006-sched-tracing-Update-trace_sched_pi_setprio.patch][4.11]]
* [  4.11         ] rtmutex: Deboost before waking up the top waiter{C::bug::livelock::semantics::order::Deboost before waking up the top waiter}
  + [[file:4.11/0001-rtmutex-Deboost-before-waking-up-the-top-waiter.patch][4.11]]
* [  4.11         ] x86/perf: Drop EXPORT of perf_check_microcode{C::maintain::refactor::remove export code}
  + [[file:4.11/0018-x86-perf-Drop-EXPORT-of-perf_check_microcode.patch][4.11]]
* [  4.11         ] hwtracing/coresight-etm4x: Use cpuhp_setup_state_nocalls_cpuslocked(){C::performance::hardware::add new function to optimizing hotplug cup}
  + [[file:4.11/0012-hwtracing-coresight-etm4x-Use-cpuhp_setup_state_noca.patch][4.11]]
* [  4.11         ] init: Introduce SYSTEM_SCHEDULING state{C::maintain::refactor::introduce SYSTEM_SCHEDULING state}
...
* [  4.11         ] cpufreq/ia64: Replace racy task affinity logic{C::feature::sched::replace with work_on_cpu()}
  + [[file:4.11/0009-cpufreq-ia64-Replace-racy-task-affinity-logic.patch][4.11]]
* [  4.11         ] rtmutex: Provide rt_mutex_lock_state(){C::maintain::refactor::add rtmutex state function}
...
* [  4.11         ] futex: Avoid freeing an active timer{C::maintain::refactor::add httimer_cancel() to cancel freeing timer}
  + [[file:4.11/0001-futex-Avoid-freeing-an-active-timer.patch][4.11]]
* [  4.11         ] cpuhotplug: Link lock stacks for hotplug callbacks{C::feature::check::add lockdep to detected deadlock}
  + [[file:4.11/0032-cpuhotplug-Link-lock-stacks-for-hotplug-callbacks.patch][4.11]]
* [  4.11         ] init: Pin init task to the boot CPU, initially{C::bug::hwerr::hardware::hardware::Pin init task to the boot CPU}
  + [[file:4.11/0001-init-Pin-init-task-to-the-boot-CPU-initially.patch][4.11]]
* [  4.11         ] ACPI: Adjust system_state check{C::maintain::refactor::adjust system_state check}
  + [[file:4.11/0007-ACPI-Adjust-system_state-check.patch][4.11]]
* [  4.11         ] cpu/hotplug: Add __cpuhp_state_add_instance_cpuslocked(){C::feature::hardware::Add __cpuhp_state_add_instance_cpuslocked() for cpu hotplug}
  + [[file:4.11/0004-cpu-hotplug-Add-__cpuhp_state_add_instance_cpuslocke.patch][4.11]]
* [  4.11         ] futex: Change locking rules{C::performance::mutex::chang locking rules}
  + [[file:4.11/0005-futex-Change-locking-rules.patch][4.11]]
* [  4.11         ] kernel: sched: Provide a pointer to the valid CPU mask{C::maintain::refactor::replace CPU mask with pointer}
  + [[file:4.11/kernel-sched-Provide-a-pointer-to-the-valid-CPU-mask.patch][4.11]]
* [  4.11         ] iommu/vt-d: Adjust system_state checks{C::maintain::refactor::Adjust system_state checks}
  + [[file:4.11/0010-iommu-vt-d-Adjust-system_state-checks.patch][4.11]]
* [  4.11         ] net/core: disable NET_RX_BUSY_POLL{C::maintain::refactor::add !PREEMPT_RT_FULL config}
  + [[file:4.11/net_disable_NET_RX_BUSY_POLL.patch][4.11]]
* [  4.11         ] perf/x86/intel/cqm: Use cpuhp_setup_state_cpuslocked(){C::performance::hardware::add new function to optimizing hotplug cup}
  + [[file:4.11/0013-perf-x86-intel-cqm-Use-cpuhp_setup_state_cpuslocked.patch][4.11]]
* [  4.11         ] perf/tracing/cpuhotplug: Fix locking order{C::bug::livelock::order::semantics::introuce pmus_mutex}
  + [[file:4.11/0023-perf-tracing-cpuhotplug-Fix-locking-order.patch][4.11]]
* [  4.11         ] padata: Avoid nested calls to cpus_read_lock() in pcrypt_init_padata(){C::maintain::refactor::remove/add some function}
  + [[file:4.11/0007-padata-Avoid-nested-calls-to-cpus_read_lock-in-pcryp.patch][4.11]]
* [  4.11         ] rtmutex: Plug preempt count leak in rt_mutex_futex_unlock(){C::maintain::refactor::merge code}
  + [[file:4.11/0009-rtmutex-Plug-preempt-count-leak-in-rt_mutex_futex_un.patch][4.11]]
* [  4.11         ] cpufreq/sparc-us3: Replace racy task affinity logic{C::bug::crash::na::semantics::straight call smp function}
...
* [  4.11         ] workqueue: Provide work_on_cpu_safe(){C::feature::hardware::add function for CPU hotplug}
  + [[file:4.11/0002-workqueue-Provide-work_on_cpu_safe.patch][4.11]]
* [  4.11         ] cpufreq: Use cpuhp_setup_state_nocalls_cpuslocked(){C::performance::hardware::add new function to optimizing hotplug cup}
  + [[file:4.11/0009-cpufreq-Use-cpuhp_setup_state_nocalls_cpuslocked.patch][4.11]]
* [  4.11         ] arm: Prevent hotplug rwsem recursion{C::feature::check::add function to check unprotect callers and avoid recursion}
...
* [  4.11         ] MAINTAINERS: Add FUTEX SUBSYSTEM{C::maintain::refactor:: Add FUTEX SUBSYSTEM to MAINTAINERS}
  + [[file:4.11/0004-MAINTAINERS-Add-FUTEX-SUBSYSTEM.patch][4.11]]
* [  4.11         ] delayacct: use raw_spinlocks{C::performance::mutex::replace with raw}
  + [[file:4.11/delayacct-use-raw_spinlocks.patch][4.11]]
* [  4.11         ] futex/rtmutex: Cure RT double blocking issue{C::feature::debuginfo}
  + [[file:4.11/futex-rtmutex-Cure-RT-double-blocking-issue.patch][4.11]]
* [  4.11         ] sched: Provide is_percpu_thread() helper{C::feature::check::provide a helper for check}
  + [[file:4.11/0030-sched-Provide-is_percpu_thread-helper.patch][4.11]]
* [  4.11         ] rtmutex: Clean up{C::maintain::refactor::update comments and code}
...
* [  4.11         ] softirq: wake the timer softirq if needed{C::performance::softirq::add #ifdef to wake the timer softirq if need}
  + [[file:4.11/softirq-wake-the-timer-softirq-if-needed.patch][4.11]]
* [  4.11         ] futex: Futex_unlock_pi() determinism{C::feature::statistics::add some function to acquire state}
  + [[file:4.11/0012-futex-Futex_unlock_pi-determinism.patch][4.11]]
* [  4.11         ] rtmutex: Fix more prio comparisons{C::feature::sched::add rt_mutex_waiter_equal to fix prio comparisons}
  + [[file:4.11/0008-rtmutex-Fix-more-prio-comparisons.patch][4.11]]
* [  4.11         ] PCI: Replace the racy recursion prevention{C::bug::na::na::semantics::use check and make method to replace the racy}
...
* [  4.11         ] ACPI/processor: Replace racy task affinity logic{C::bug::hwerr::hardware::hardware::replace with work_on_cpu()}
  + [[file:4.11/0008-ACPI-processor-Replace-racy-task-affinity-logic.patch][4.11]]
* [  4.11         ] powerpc/powernv: Use stop_machine_cpuslocked(){C::performance::hardware::Use stop_machine_cpuslocked()}
  + [[file:4.11/0016-powerpc-powernv-Use-stop_machine_cpuslocked.patch][4.11]]
* [  4.11         ] ARM/hw_breakpoint: Use cpuhp_setup_state_cpuslocked(){C::performance::hardware:: cpuhp_setup_state_cpuslocked()}
  + [[file:4.11/0014-ARM-hw_breakpoint-Use-cpuhp_setup_state_cpuslocked.patch][4.11]]
* [  4.11         ] sparc/sysfs: Replace racy task affinity logic{C::performance::hardware::Replace racy task affinity logic use work_on_cpu()}
  + [[file:4.11/0006-sparc-sysfs-Replace-racy-task-affinity-logic.patch][4.11]]
* [  4.11         ] futex: Use smp_store_release() in mark_wake_futex(){C::maintain::refactor::merge code}
  + [[file:4.11/0002-futex-Use-smp_store_release-in-mark_wake_futex.patch][4.11]]
* [  4.11         ] sched: Prevent task state corruption by spurious lock wakeup{C::bug::corrupt::semantics::semantics::replace TASK_ALL with TASK_UNINTERRUPTIBLE}
  + [[file:4.11/sched-Prevent-task-state-corruption-by-spurious-lock.patch][4.11]]
* [  4.11         ] hwtracing/coresight-etm3x: Use cpuhp_setup_state_nocalls_cpuslocked(){C::performance::hardware::Use cpuhp_setup_state_nocalls_cpuslocked()}
  + [[file:4.11/0011-hwtracing-coresight-etm3x-Use-cpuhp_setup_state_noca.patch][4.11]]
* [  4.11         ] ia64/sn/hwperf: Replace racy task affinity logic{C::bug::crash::na::semantics::using work_on_cpu_safe()}
  + [[file:4.11/0004-ia64-sn-hwperf-Replace-racy-task-affinity-logic.patch][4.11]]
* [  4.11         ] stop_machine: Provide stop_machine_cpuslocked(){C::maintain::refactor::Provide stop_machine_cpuslocked() for introducing rwsem}
  + [[file:4.11/0005-stop_machine-Provide-stop_machine_cpuslocked.patch][4.11]]
* [  4.11         ] x86/mtrr: Remove get_online_cpus() from mtrr_save_state(){C::maintain::refactor::remove pointless function}
  + [[file:4.11/0008-x86-mtrr-Remove-get_online_cpus-from-mtrr_save_state.patch][4.11]]
* [  4.11         ] futex: Pull rt_mutex_futex_unlock() out from under hb->lock{C::performance::mutex::change previous changs with new method}
  + [[file:4.11/0008-futex-Pull-rt_mutex_futex_unlock-out-from-under-hb-l.patch][4.11]]
* [  4.11         ] PCI: Use cpu_hotplug_disable() instead of get_online_cpus(){C::feature::check::replace with cpu_hotplug_disable()}
  + [[file:4.11/0020-PCI-Use-cpu_hotplug_disable-instead-of-get_online_cp.patch][4.11]]
* [  4.11         ] futex,rt_mutex: Fix rt_mutex_cleanup_proxy_lock(){C::bug::crash::na::mutex::add try_to_take_rt_mutex(),reorder code}
  + [[file:4.11/futex-rt_mutex-Fix-rt_mutex_cleanup_proxy_lock.patch][4.11]]
* [  4.11         ] futex,rt_mutex: Introduce rt_mutex_init_waiter(){C::maintain::refactor::Organize the code as a function}
...
* [  4.11         ] lock(){C::maintain::refactor::rename function}
  + [[file:4.11/0001-cpu-hotplug-Provide-cpus_read-write_-un-lock.patch][4.11]]
* [  4.11         ] cpufreq/sh: Replace racy task affinity logic{C::feature::other::replace with work_on_cpu()}
...
* [  4.11         ] arm64: Prevent cpu hotplug rwsem recursion{C::feature::check::replace with _cpuslocked() to check lock}
...
* [  4.11         ] cpufreq/sparc-us2e: Replace racy task affinity logic{C::performance::smallsize::replace with straight forward smp function call}
...
* [  4.11         ] jump_label: Reorder hotplug lock and jump_label_lock{C::feature::rtsupport::remove some lock,reorder lock, add some lock}
...
* [  4.11         ] padata: Make padata_alloc() static{C::maintain::refactor::Make padata_alloc() static}
  + [[file:4.11/0006-padata-Make-padata_alloc-static.patch][4.11]]
* [  4.11         ] ia64/salinfo: Replace racy task affinity logic{C::feature::hardware::use work_on_cpu_safe() to support cpu hotplug and concurrent affinity}
...
* [  4.11         ] s390: Prevent hotplug rwsem recursion{C::feature::check::use stop_machine_cpuslocked() to contain a lockdep}
