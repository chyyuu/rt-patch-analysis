...
* [2.6.26         ] ftrace-compile-fixes.patch {C::bug::compile::compiling_err::syntax:: remove call to stop tracer}
  ...
  - 2.6.29
* [2.6.26         ] m68knommu_fixes_ontop_of_v2.6.26.patch {C::?}
...
* [2.6.26         ] ftrace-record-comm-on-ctrl.patch {C::feature::debuginfo::ftrace: record comm on function ctrl change}
  ...
  - 2.6.29
* [2.6.26         ] lockstat-fix-contention-points.patch {C::bug::?::semantics::semantics::lockstat: fix contention points}
...
* [2.6.26         ] sched-cpupri-priocount.patch {C::bug::data_err::semantics::semantics::rounding error off by one}
  ...
  - 2.6.29
* [2.6.26         ] lockdep-avoid-fork-waring.patch {C::bug::?::semantics::semantics::The preprocessor condition }
...
* [2.6.26 - 2.6.29] adapt-remove-extra-try-to-lock.patch {C::performance::smallsize::remove the extra call to try_to_take_lock}
  ...
  - 3.0
* [2.6.26 - 2.6.29] sched-fix-dequeued-race.patch {C::bug::?::sched::sched::sched-fix-dequeued-race}
...
* [2.6.29         ] disable-maxcpus-for-now.patch{C::feature::rtsupport::disable maxcpus configure item}
  ...
  - 3.0
* [2.6.29         ] preempt-rt-x86-pageattr-flush-unused.patch{C::?::disable a function call}
...
* [2.6.29         ] cpu-hotplug: vs slab{C::feature::rtsupport::fix up the slab allocator to be cpu-hotplug safe}
  ...
  - 3.0
* [2.6.29         ] slab-free-pages.patch{C::?}
...
* [2.6.29         ] rt: convert stop_machine_run() to PREEMPT_RT{C::feature::rtsupport::rt: convert stop_machine_run() to PREEMPT_RT}
  ...
  - 3.0
* [2.6.29         ] powerpc-compat-semaphore.patch{C::?::}
...
* [2.6.29         ] lockdep: fix compat_sema_init{C::bug::na::uninit_var::memory::spin_lock_init}
  ...
  - 3.0
* [2.6.29         ] x86-microcode-fix-sysfs-wreckage.patch{C::bug::?::hardware::hardware::x86-microcode-fix-sysfs-wreckage}
...
* [2.6.29         ] hrtimer-fix-wait-for-hrtimer.patch{C::bug::hwerr::time::semantics::hrtimer-fix-wait-for-hrtimer}
  ...
  - 3.0
* [2.6.29         ] cpu-hotplug: cpu_down vs preempt-rt{C::?}
  + [[file:2.6.29/cpuhotplug-idle.patch][2.6.29]]
  - 3.0
* [2.6.29         ] rtmutex: remove uber optimization{C::?}
...
* [2.6.29         ] rt: xfs fix{C::feature::rtsupport::XFS still relies on compat semaphore}
  ...
  - 3.0
* [2.6.29         ] rt: mutex core fixes{C::bug::?::mutex::mutex::replace rwsem_is_locked with compat_rwsem_is_locked}
...
* [2.6.29         ] add -rt extra-version{C::feature::rtsupport:: rtmutex support}
  ...
  - 3.0
* [2.6.29         ] preempt-realtime-x86-32-gup-kmapatomic.patch{C::feature::mm::?}
...
* [2.6.29         ] preempt-realtime-debugobjects-rt-safe.patch{C::bug::data_err::atomicity::mutex::replace spinlock_t with raw_spinlock_t}
  ...
  - 3.0
* [2.6.29         ] mm-lock-break-on-bulk.patch{C::?}
...
* [2.6.29         ] rt: res_counter fix{C::bug::hwerr::irq::irq::replace local_irq_save with local_irq_save_nort}
  ...
  - 3.0
* [2.6.29         ] suppress warning of smp_processor_id use.{C::bug::?::preempt::preempt::use preempt_disable() to supress waring message}
...
* [2.6.29         ] irq: desc init{C::feature::rtsupport::replace __SPIN_LOCK_UNLOCKED with RAW_SPIN_LOCK_UNLOCKED}
  ...
  - 3.0
* [2.6.29         ] rtmutex: prevent missed wakeups{C::bug::?::semantics::semantics::rtmutex: prevent missed wakeups}
...
* [2.6.29         ] rt: fix paravirt spinlocks{C::feature::rtsupport:: use __raw_spinlock_t instead of raw_spinlock_t}
  ...
  - 3.0
* [2.6.29         ] rtmutex-mutex-fixups.patch{C::bug::?::semantics::semantics:: chang conditional compile}
...
* [2.6.29         ] rt: irq handle.c fix2{C::bug::hwerr::irq::irq::direct-keyboard-sparseirq-fix}
  ...
  - 3.0
* [2.6.29         ] x86-pae-preempt-realtime-fix.patch{C::bug::?::preempt:preempt::add preempt_disable protect}
...
* [2.6.29 -    3.4] timers: fix timer hotplug on -rt{C::bug::hwerr::irq::irq::in the CPU_DEAD notifier, must not sleep nor enable interrupts.}
  ...
  - 3.6
* [2.6.29 -    3.6] signals: Do not wakeup self{C::bug::??::semantics::semantics::signal_wake_up  signals: Do not wakeup self}
...
* [2.6.29 -   4.11] posix-timers: Prevent broadcast signals{C::bug::?::semantics::semantics:: posix-timers-prevent-broadcast-signals}
...
* [   3.6         ] Disable RT_GROUP_SCHED in PREEMPT_RT_FULL{C::feature::rtsupport::disable ...}
  ...
  - 3.8
* [   3.6         ] mm: Protect activate_mm() by preempt_[disable%7Cenable]_rt(){C::bug::??::irq::irq::replace with preempt pair}
...
* [   3.8 -   3.12] sched: Consider pi boosting in setscheduler{C::bug::rtlatency::sched::sched::sched: Consider pi boosting in setscheduler}
  ...
  - 3.18
* [   3.8 -   3.14] sched: Init idle->on_rq in init_idle(){C::bug::?::sched::sched::Init idle->on_rq in init_idle()}
...
* [  3.10 -   4.11] kernel/hotplug: restore original cpu mask oncpu/down{C::bug::?::sched::semantics::restore original cpu mask oncpu/down}
...
* [  3.12         ] drm: remove preempt_disable() from drm_calc_vbltimestamp_from_scanoutpos(){C::bug::deadlock::irq::irq::drm: remove preempt_disable() from drm_calc_vbltimestamp_from_scanoutpos()}
  ...
  - 3.14
* [  3.12         ] genirq: Set the irq thread policy without checking CAP_SYS_NICE{C::bug::?::semantics::semantics::genirq: Set the irq thread policy without checking CAP_SYS_NICE}
...
* [  3.12 -   4.11] ptrace: fix ptrace vs tasklist_lock race{C::bug::?::mutex::mutex::ptrace: fix ptrace vs tasklist_lock race}
...
* [  3.14         ] rt,sched,numa: Move task_numa_free() to __put_task_struct(), which -rt offloads
  + [[file:3.14/rt-sched-numa-Move-task_numa_free-to-__put_task_stru.patch][3.14]]{C::bug::deadlock::deadlock::semantics::rt,sched,numa: Move task_numa_free() to __put_task_struct()}
  - 3.18
* [  3.14         ] Revert "x86: Disable IST stacks for debug/int 3/stack fault for PREEMPT_RT"{C::bug::?::semantics::semantics::Revert "x86: Disable IST stacks for debug/int 3/stack fault for PREEMPT_RT"}
...
* [  3.14 -    4.0] timer: Raise softirq if there's irq_work{C::bug::deadlock::deadlock::semantics::timer: Raise softirq if there's irq_work}
  ...
  - 4.1
* [  3.14 -    4.0] timers: do not raise softirq unconditionally{C::?}
